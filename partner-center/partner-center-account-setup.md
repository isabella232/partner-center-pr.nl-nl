...
Als u uw voorkeurs-e-mail wilt bijwerken om Partner Center ontvangen:
...
Hier is een voorbeeld. Stel dat een gebruiker toegang heeft tot drie programma's in het Partner Center dashboard: het **MPN-programma,** het programma **Verwijzingen** en het **programma Commerciële marketplace.** Wanneer ze zich aanmelden bij Partner Center dashboard, zien ze deze drie programma's aan de linkerkant van het scherm.
...
Zie de volgende gedeeltelijke lijst voor meer Partner Center registratie in bepaalde programma's:
