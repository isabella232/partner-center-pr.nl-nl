...
> [!IMPORTANT]
> Partners kunnen aanvragen voor bronbelasting alleen indienen voor gedeeltelijk betaalde facturen. Voor volledig betaalde of niet-betaalde facturen kunt u contact opnemen [met de ondersteuning](report-problems-with-partner-center.md) met uw hold-certificaat.
...
2. Selecteer de **tegel Facturering** en selecteer vervolgens **Factureringsgeschiedenis.**
...
3. Selecteer **Nieuwe verzenden** naast de factuur voor wie u een machtiging wilt indienen. Met de koppeling Nieuwe belasting indienen gaat u naar **de pagina Nieuwe aanvraag voor belasting.**
   ...
   :::image type="content" source="images/billing/billing-withholding-1.png" alt-text="Verzend Nieuwe belasting voor een factuur.":::

4. Controleer de factuurgegevens om te controleren of u de aanvraag voor de juiste factuur indient.

   :::image type="content" source="images/billing/billing-withholding-2.png" alt-text="Vul de belastinggegevens voor een factuur in.":::
...
3. Zoek de aanvraag voor belasting in bronbelasting. Aanvragen die uw aandacht nodig hebben, hebben de status 'Partneractie in behandeling'.
