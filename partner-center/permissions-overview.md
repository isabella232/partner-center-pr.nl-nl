...
U hebt uw partnerprofiel ingesteld, inclusief juridische naam en adres, ondersteuningsgegevens, btw-vrijstellingen, bankgegevens en de primaire contactpersoon voor uw bedrijf. Volgende stap: stel uw gebruikers in met wachtwoorden en rollen, zodat ze met Partner Center aan de slag kunnen.
...
|----------------------------------|---|:---------------------------------|
|Globale beheerder|* Toegang tot alle Microsoft-account/services met volledige bevoegdheden|[Uw Partner Center-account beheren](partner-center-account-setup.md)
...
|Beheerder van gebruikersbeheer   | * Gebruikers weergeven, maken en beheren|[Uw voordelen Microsoft Partner Network lidmaatschap en aanbiedingen in Partner Center](manage-your-partner-network-benefits.md)
...
|------------------------------|:----------------------------|----|
|Globale beheerder| Uw CPV-profiel (Configuratiescherm Vendor) weergeven en beheren|[Registreren als een leverancier Configuratiescherm om CSP-partnersystemen te integreren met Partner Center API's](enroll-as-cpv.md)
