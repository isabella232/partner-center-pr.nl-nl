...
- De MPN-id van de partner moet behoren tot dezelfde v-org als de koperen MPN-id of de MPN-id Partner of Record (PARTNER OF RECORD). Zie [Uw partner-id koppelen om de impact op gedelegeerde resources te volgen](/azure/lighthouse/how-to/partner-earned-credit) voor meer informatie.
...
:::image type="content" source="images/advanced-specializations/recon-file.png" alt-text="Schermopname van een Partner Center het afstemmen van kolommen." border="false":::
...
PEC-inkomsten worden in rekening gebracht in de aangepaste nettokostenregel binnen de factuur. Het **totaal** van de factuur die hieronder wordt weergegeven, illustreert dit. Zie het maandelijkse factuurafstemmingsbestand en het dagelijkse gebruiksbestand van Azure voor meer informatie over aanpassingen.

:::image type="content" source="images/advanced-specializations/invoice.png" alt-text="Schermopname van een Partner Center met de mededeling dat aanpassingsgegevens worden weergegeven in recon- en dagelijkse Gebruiksbestanden van Azure." border="false":::
