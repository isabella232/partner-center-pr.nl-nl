...
Zie Aan de slag als indirecte reseller op de website van [](https://partner.microsoft.com/cloud-solution-provider/whats-required) Microsoft Partner Network voor meer informatie over wat er nodig is om in het CSP-programma te verkopen als een indirecte [reseller.](https://partner.microsoft.com/)
...
4. Koppel uw MPN-id aan uw CSP-account. Uw CSP-account en de bijbehorende MPN-id moeten zich in hetzelfde land bevinden en uw MPN-id moet zich in hetzelfde Partner Center.
    ...
    Als u zich niet hebt geregistreerd [](mpn-overview.md) bij het MPN-programma, moet u zich vandaag nog inschrijven en vervolgens doorgaan met de CSP-inschrijving.
