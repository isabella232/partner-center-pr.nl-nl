...
5. Koppel uw MPN-id aan uw CSP-account. Uw CSP-account en de bijbehorende MPN-id moeten zich in hetzelfde land bevinden en uw MPN-id moet zich in hetzelfde Partner Center.
   ...
   2. Ga naar **Instellingen**  ->  **Account Instellingen**  ->  **Organisatieprofiel-id's.**  ->  
   ...
   5. U kunt deze stap voorlopig uitstellen, maar u kunt geen Microsoft Partner-overeenkomst(MPA) of transact in CSP ondertekenen totdat u uw MPN-id aan uw CSP-account hebt koppelen.
