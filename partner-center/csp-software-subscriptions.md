...
## <a name="server-subscription-download-and-license-keys-available-through-microsoft-365-admin-center-for-customers"></a>Download- en licentiesleutels voor serverabonnementen die beschikbaar zijn via Microsoft 365-beheercentrum voor klanten 

Uw klanten kunnen licentiesleutels voor CSP-serverabonnementen en downloads ophalen uit Microsoft 365-beheercentrum. Als de klant de licentiesleutels en downloads van het CSP-serverabonnement wilt zien, gaat hij naar het Microsoft 365-beheercentrum > facturering > het tabblad Uw **producten > Software.** Zie het tabblad Software onder [Facturering voor meer informatie.](/microsoft-365/admin/whats-new-in-preview#billing--subscriptions)  
...
>[!IMPORTANT]
>Nadat u een order hebt geannuleerd, wordt er een bericht weergegeven waarin de annulering wordt bevestigd. Er kan echter een vertraging van maximaal 15 minuten zijn voordat de annulering wordt weergegeven op Partner Center dashboard. 
