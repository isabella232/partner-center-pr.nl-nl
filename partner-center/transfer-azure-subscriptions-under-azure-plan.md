...
description: Meer informatie over het wijzigen Cloud Solution Provider partner van het programma dat is gekoppeld aan de Azure-abonnementen van een klant onder een Azure-plan.
ms.custom: SEOMAY.20
...
6. Selecteer **Accepteren en overdragen om** het overdrachtsproces te voltooien:
   ...
   Als u een klant hebt met eerdere Azure-aanbiedingsabonnementen (MS-AZR-0145p), gaat u  op dezelfde manier door, kiest u de abonnementen die u wilt overdragen en selecteert u Vervolgens Accepteren en overdragen om het overdrachtsproces te voltooien.
