...
:::image type="content" source="images/payouts/payout-overview.png" alt-text="Schermopname van het uitbetalingspictogram in de rechterbovenhoek van Partner Center portal.":::
...
| serviceFeeTax | Totale hoeveelheid serviceFeeTax in de valuta Betalen naar voor het programma/de participantID (alleen van toepassing op store-programma's en Azure Marketplace) |
