...
Hoewel uw bedrijf na 30 april 2021 geen toegang meer heeft tot PSC, vindt u nog steeds alles wat u in Partner Center wilt doen, zoals het maken van deals voor co-verkoop, het beheren van uw deals en het handelen op deals die naar u worden verzonden door Microsoft-verkopers.
...
2. De PSC-gebruiker gebruikt mogelijk een account uit een ander domein dan het account dat u in de Partner Center.
   ...
   Als u fouten met betrekking tot scenario 1 en 2 wilt oplossen, vraagt u de gebruiker om zich aan te melden bij Partner Center met het werkaccount dat is gekoppeld aan uw Azure AD-tenant. Uw [globale beheerder](permissions-overview.md#manage-commercial-transactions-in-partner-center-azure-ad-and-csp-roles) kan u helpen.
...
1. Weergave van details van PSC-deal die is Partner Center de details van de deal
1. PsC-weergave Producten toevoegen die is Partner Center weergave Oplossingen toevoegen
1. Psc-gebruikersbeheerweergave die is Partner Center de weergave voor gebruikersbeheer
