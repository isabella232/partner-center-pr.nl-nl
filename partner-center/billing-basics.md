...
ms.topic: article
ms.date: 01/28/2021
description: Meer informatie over basisfacturerings- en factuurgegevens voor CSP-partners in Partner Center. Dit artikel bevat informatie over het factureren van klanten en het zoeken en lezen van uw factuur.
...
**Facturering op basis van licenties** en gebruik: er worden producten gefactureerd in de valuta van het land of de regio waarin u zich bevindt. U wordt hetzelfde gefactureerd, ongeacht de locatie van de klant aan wie u de producten hebt verkocht.

**Een keer factureren:** vanaf augustus 2021 worden alle partners gefactureerd in de valuta van de partnerlocatie, ongeacht de locatie van de klant aan wie u de producten hebt verkocht. Lees meer over [eenmalige en terugkerende](azure-plan-billing.md). 
...
Betalingsvoorwaarden zijn netto 60 dagen. Facturen moeten worden betaald op de einddatum van de factuur (60 dagen na de factureringsdatum), anders is uw account delinquent, wat van invloed kan zijn op uw inschrijving in CSP. 
...
U vindt meer belastinggegevens van uw lokale belastingbureau of belastingadviseur.
