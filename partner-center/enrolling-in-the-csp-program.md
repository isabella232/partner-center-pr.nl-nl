...
1. Meld u aan [bij Partner Center dashboard met](https://partner.microsoft.com/dashboard/) uw werk-e-mailadres (dat wil zeggen, de referenties van uw Azure AD-tenant).
...
4. Tijdens de verificatie kunnen we u om een ander document vragen of vragen om een enquête in te vullen. Het kan enkele dagen duren voordat de gegevens die u hebt verstrekt, worden gecontroleerd en geverifieerd. We sturen u een e-mail nadat we onze beoordeling hebben voltooid.
