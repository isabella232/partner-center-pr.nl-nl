...
Deze pagina bevat de aankondigingen voor Microsoft Partner Center voor september 2021.
 ...
 _______________
## <a name="view-the-latest-promotions-and-offers"></a><a name="16"></a>De meest recente promoties en aanbiedingen weergeven
...
Ons doel is om Partner Center effectiefste digitale hulpprogramma in ons ecosysteem te maken, zodat u kunt profiteren van alle mogelijkheden in het Microsoft-partnerecosysteem. Partner Center vereenzaakt zakelijke transacties, bevordert het opbouwen van relaties met andere partners en biedt robuuste analyses. Om u te helpen het beste uit uw samenwerking met Microsoft te halen in elke fase van het partnertraject, moet het continu de meest recente informatie, processen en feedback van partners integreren naarmate we de algehele partnerervaring ontwikkelen. Omdat we de afgelopen jaren incrementele aanpassingen hebben aangebracht, willen we graag een nieuwe gebruikerservaring met intuïtieve navigatie, een consistentere ervaring en een begeleid pad naar het vinden van de meest relevante informatie en het voltooien van de acties die u moet uitvoeren in Partner Center.

Vandaag beginnen we met het uitrollen van de eerste van verschillende fasen in een nieuwe gebruikerservaring voor Partner Center. De handtekeningkenmerken van deze update zijn werkruimten, die een nieuwe manier zijn om assets en informatie per werkstroom te ordenen. Het implementeren van een structuur die is gebouwd rond werkruimten, maakt een diepere personalisatie mogelijk en maakt het voor partners eenvoudiger om Partner Center te gebruiken: voordelen die zijn gebaseerd op express-aanvragen van gebruikers. We blijven aanvullende wijzigingen aanbrengen om de prestaties en betrouwbaarheid van elke werkruimte te verbeteren. Omdat we onze digitale mogelijkheden willen versterken, hebben we er vertrouwen in dat onze investering in deze update u zal ondersteunen bij het dynamisch versnellen van uw bedrijfsgroei.

Laten we eens kijken naar de voordelen van de nieuwe structuur, het implementatieproces en de resources om vertrouwd te raken met de nieuwe ervaring.  

#### <a name="introducing-workspaces"></a>Introductie van werkruimten

De nieuwe Partner Center is gebouwd rond een set werkruimten die wordt weergegeven op de startpagina. In elke werkruimte vindt u de hulpprogramma's, koppelingen, rapporten en informatie die zijn gekoppeld aan het onderwerp van de werkruimte. De werkruimten tot wie u toegang hebt, worden aangepast op basis van de activiteiten van uw organisatie met Microsoft.
...
Deze wijzigingen zijn het gevolg van feedback van partners en zijn ontworpen om Partner Center intuïtiever te maken om te navigeren. De wijzigingen die we aanbrengen, brengen Partner Center ook in overeenstemming met andere Microsoft-portals (zoals de Microsoft Azure-portal of Microsoft 365-beheer Center) en resourcebibliotheken die u mogelijk gebruikt, zodat u efficiënter zakelijke beslissingen kunt nemen. 

#### <a name="transitioning-to-the-new-user-experience"></a>Overstappen naar de nieuwe gebruikerservaring

Vanaf vandaag 27 september hebben alle partnerorganisaties en -gebruikers toegang tot de nieuwe gebruikerservaring. Wanneer u zich aanmeldt bij Partner Center, ziet u mogelijk nog  steeds de huidige weergave, maar u kunt rechtsboven op de pagina de knop Werkruimten selecteren om tussen de oude en de nieuwe interface te schakelen. De nieuwe ervaring wordt de komende weken tot 15 november 2021 geleidelijk uitgerold. Gedurende die periode hebt u de mogelijkheid om te schakelen tussen de oude en nieuwe ervaringen.
...
Ons team blijft de gebruikerservaring tijdens en na deze implementatie bijwerken op basis van gebruikersgegevens en directe invoer en feedback. Door terug te schakelen naar de bestaande gebruikersinterface, ziet u een venster **Feedback** geven dat u kunt gebruiken om ons ontwikkelteam te bereiken.

### <a name="next-steps"></a>Volgende stappen

We hebben resources gecompileerd om u vertrouwd te maken met uw opnieuw ontworpen Partner Center. Hoewel er sprake is van pariteit in gegevenspunten en functies tussen de oude en nieuwe interfaces, moet u mogelijk even de tijd nemen om te leren waar u bepaalde informatie kunt vinden. Om u inzicht te geven in de nieuwe structuur, heeft elke werkruimte een hovercard die, wanneer u de muis er boven houdt, een korte beschrijving en nuttige koppelingen biedt. U kunt ook snel informatie vinden die is geordend op werkruimte in de [Partner Center online help](../get-around-partner-center.md).

Deze aankondiging is ook beschikbaar als [blogpost en](https://blogs.partner.microsoft.com/mpn/the-redesigned-partner-center-experience-is-here/) een verzameling is beschikbaar in de [Operations Resource Gallery.](https://partner.microsoft.com/resources/collection/the-redesigned-partner-center-experience#/)
...
Of u nu een oplossing bouwt, op de markt gaat of samen met Microsoft verkoopt, de nieuwe Partner Center is ontworpen om de productiviteit te stroomlijnen. Op de hoogte van en afgestemd op uw organisatie en rol, is deze update onze meest recente investering in onze samenwerking. Het verbeteren Partner Center is nog maar het begin van de volgende fase van onze toekomst samen, en mijn team en ik horen graag hoe uw praktijk er met deze stap toe wordt verhoogd.

________________
## <a name="new-commerce-experience-for-cloud-solution-provider-csp-seat-based-offers-readiness-resources"></a><a name="14"></a>Nieuwe commerce-ervaring voor Cloud Solution Provider (CSP)-seat biedt gereedheidsbronnen

### <a name="summary"></a>Samenvatting

Dit is een samenvatting van de belangrijkste resources die u nodig hebt om u voor te bereiden op de introductie van de nieuwe commerce-ervaring voor CSP-aanbiedingen op basis van een seat.
...
Sinds 19 augustus 2021 [](./2021-august.md#14) is de aanstaande lancering van aanbiedingen op basis van seat in de nieuwe commerce-ervaring openbaar gemaakt. Microsoft heeft diverse gereedheidsbronnen beschikbaar gesteld. Deze materialen zijn ontworpen om partners snel meer te leren over wijzigingen in programma's, platformen en bedrijfsregelen.
...
Microsoft biedt tal van gereedheidsbronnen waarmee partners snel meer te weten kunnen komen over wijzigingen in programma's, platforms en bedrijfsregelen. De gereedheidskaart helpt u naar deze materialen te gaan om uw beoordelingsinspanningen te optimaliseren. Nieuwe assets die aan de verzameling worden toegevoegd, worden ook toegevoegd aan de gereedheidskaart.
...
De bedieningshandleiding biedt een gedetailleerdere weergave (in vergelijking met de grafiekactiva [L100,](https://partner.microsoft.com/resources/detail/l100-new-commerce-experience-pdf) [L200](https://partner.microsoft.com/resources/detail/l200-new-commerce-experience-pdf)en [Abonnementsbeheer)](https://partner.microsoft.com/resources/detail/table-compares-new-old-experience-pdf) en biedt inzicht in hoe u Microsoft 365-, Dynamics 365-, Power Platform- en Windows 365-aanbiedingen in de nieuwe commerce-ervaring kunt gebruiken en vervolgens kunt transacteren.

De operationele handleiding wordt voortdurend bijgewerkt met informatie over functies en toevoegingen op basis van vragen van partners. Bekijk het wijzigingslogboek om te zien welke updates zijn aangebracht in het document.

#### <a name="partner-trainings"></a>Partnertrainingen

**[CSP Community Call Q&As](https://globalpbocomm.eventbuilder.com/GlobalCSP)**

CSP Community Call Q&As is speciaal bedoeld voor het ondersteunen van CSP-partners voor directe factuur en indirecte providers die vragen hebben met betrekking tot CSP-lanceringen en toekomstige wijzigingen. Communityverzamelingen worden van tevoren beschikbaar gesteld in de [galerie Gereedheid](https://partner.microsoft.com/resources/assets/#/?prog=CSP%7CCSP-Direct%7CCSP-Indirect-Partner&type=collection&search=community%20collection%202021&sort=updated) van partners, waar u materiaal kunt bekijken dat moet worden besproken in de Q&A.

Als u niet kunt deelnemen aan de CSP Community Call Q&As op 15 en 16 [](https://globalpbocomm.eventbuilder.com/GlobalCSP) september 2021, registreert u zich om de opname voor uw regio te bekijken.

Vanaf oktober kunnen partners [](https://globalpbocomm.eventbuilder.com/GlobalCSP) zich nu registreren voor de CSP Community Call Q&Zoals plaatsvindt op 20 en 21 oktober 2021. Tijdens de CSP Community Call van oktober gaan we dieper in op enkele operationele aspecten van deze op CSP-seat gebaseerde lancering en moeten partners klaar zijn om hun vragen te bespreken en te brengen.

Naast de geplande CSP Community Call Q&As biedt Microsoft partners extra gereedheidsmogelijkheden voor de nieuwe commerce-ervaring voor CSP-aanbiedingen op basis van seat. Tijdens deze aanroepen bekijken we hoe Microsoft 365- en Dynamics 365-, Power Platform- en Windows 365-aanbiedingen in de nieuwe commerce-ervaring kunnen worden verhandelt, en bekijken we nieuwe functies, mogelijkheden en beleidsregels die verschillen van het oude CSP-inrichtingsplatform.

Om u voor te bereiden op deze aanroepen:
...
Vanaf oktober 2021 implementeert Microsoft API-beperking voor consistentere prestaties binnen een periode voor partners die de api'Partner Center aanroepen.Om te voorkomen dat resources te veel worden gebruikt, beperkt beperking het aantal aanvragen voor een service binnen een periode.Wanneer een drempelwaarde voor beperking wordt overschreden, Partner Center verdere aanvragen van die client voor een bepaalde periode beperkt.
  
...
- De [Global Promo Readiness Guide](https://partner.microsoft.com/resources/collection/global-promo-readiness-guide-collection#/) waarin recente en toekomstige promoties worden verzameld die beschikbaar zijn voor partners en klanten.
...
- [Vernieuwingen en herinneringen over belangrijke](https://partner.microsoft.com/resources/detail/csp-september-2021-refreshers-and-reminders-pdf) CSP-onderwerpen die interesse en query's ontvangen.
...
- De verwijzingsmodule voor leads en het beheer van het delen van kansen voor co-verkoop.
...
- [Richtlijnen en machtigingen die nodig zijn voor het publiceren van een aanbieding in de commerciële marketplace (downloads PowerPoint presentatie)](https://assetsprod.microsoft.com/mpn/guidance-and-permissions-needed-to-publish-an-offer-and-co-sell-with-ms.pptm)
...
We vragen ook aan alle partners die transacties in de EU/EFTA-landen hebben verricht om eventuele extra resellers (maximaal 5) te declareeren die bij de transactie betrokken zijn.
...
| Abonnement beheren (schakelaar automatisch verlengen, plaatsen toevoegen, beweging annuleren) | Gratis proefversies (alleen MAC-presentment) |
...
- **Verbeterde partnerervaring**  Microsoft investeert begin oktober in één betrokkenheids- en activiteitsplatform binnen Partner Center dat een gecentraliseerd doel is voor partners om incentives te verdienen bij aankoopmotie en fasen van de levenscyclus van de klant.
