...
ms.locfileid: "123956812"
---
# <a name="january-2020-announcements"></a>Aankondigingen van januari 2020

Deze pagina geeft informatie over de aankondigingen voor Microsoft Partner Center voor januari 2020.
...
Microsoft Teams-ruimten is de native conferentieoplossing van Microsoft voor Microsoft Teams en Skype voor Bedrijven vergaderingen. Met de Vergaderruimte- en vergaderingen-invoegruimte voor Microsoft Teams-ruimten kunnen de vergaderruimten en huddle-ruimten van uw GCC-klanten deelnemen aan Teams- en Skype voor Bedrijven-vergaderingen, vergaderingen hosten waar deelnemers kunnen bellen om vergaderingen te voeren en verbinding kunnen maken met telefonie via telefoonsystemen.
...
UPDATE: De afgelopen week hebben we geluisterd naar uw feedback over de implementatie van onze selfserviceaankoopmogelijkheden voor Power Platform producten. Bedankt voor degenen die uw invoer hebben verstrekt. Op basis van uw feedback hebben we onze benadering aangepast om beter te voldoen aan de behoeften van zowel IT-beheerders als eindgebruikers binnen organisaties. We brengen de volgende wijzigingen aan in ons plan:
...
- Aankoop via selfservice voor Power BI en details voor Power Apps, Power Automate en andere landen: - 14 januari 2020
...
- Bekijk alle Insights voor toegang, navigatie, rapportoverzichten & gebruik, feedback geven en meer hier: Aankondiging van een nieuw rapportagedashboard [(bèta) in Partner Center](https://partner.microsoft.com/resources/collection/partner-center-insights-reporting-dashboard#/)
...
Vanaf 1 februari 2020 is de bevestiging van de Microsoft-klantovereenkomst van een partner vereist om nieuwe orders te kunnen plaatsen voor CSP-aanbiedingen in alle regio's onder microsoft Public Cloud. Vanaf die datum kan een partner in de CSP geen nieuwe aankoop doen, waaronder het wijzigen van seats en het verlengen van bestaande aankopen zonder de acceptatie van de Microsoft-klantovereenkomst van de klant.

>[!NOTE] 
>Microsoft-klantovereenkomst en de nieuwe commerce-ervaring in CSP voor Azure:** Acceptatie door de klant van de Microsoft-klantovereenkomst is vereist voor aankoop via de nieuwe [commerce-ervaring in CSP voor Azure](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/) die vanaf 1 november 2019 beschikbaar is.
...
- Train uw agents en resellers op basis van de nieuwe voorwaarden van de overeenkomst en bij het presenteren van de nieuwe overeenkomst en het valideren van de acceptatie van de klant. Indirecte providers moeten samenwerken met indirecte resellers om de acceptatie van een klant te valideren.
...
## <a name="price-list-and-offer-update-schedule-for-january-2020"></a><a id="2"/></a>Prijslijst en updateschema voor aanbieding voor januari 2020
...
Volgens de planningen voor het vergrendelen van feestdagen zijn de prijslijsten van januari 2020 beschikbaar op 6 januari om 18:00 Pacific Standard Time (PST) in plaats van de gebruikelijke beschikbaarheidsplanning.

### <a name="details"></a>Details:

Vanwege de vakantieplanning is de prijslijstupdates die worden gepost op de [Partner Center-verkooppagina](https://partner.microsoft.com/pcv/sales) voor januari 2020 beschikbaar op 6 januari om 18:00 Pacific Standard Time (PST) in plaats van de gebruikelijke beschikbaarheid, die op de laatste dag van elke maand om 18:00 uur Pacific Standard Time (PST) is. De catalogusupdates zijn ook beschikbaar op 6 januari, in overeenstemming met de prijslijstupdates. De planning voor januari 2020 is voor alle prijslijsten die op de Partner Center worden geplaatst:
...
- Aanbieding: Microsoft Forms Pro USL for GCC Offer ID: 1e9dab89-7a71-4aa9-a3e5-9b8be2f296ba
...
- Office 365 A1 voor de aanbiedings-id van de onderwijsmedewerkers (voor apparaat) :`0757d14e-7c57-456f-8dab-47d164f2ff1f`
...
- Partners die Dynamics 365 aanbieden via het Cloud Solution Provider-programma (CSP) (deze updates hebben betrekking op alle locaties over de hele wereld, tenzij anders wordt geadviseerd.)

### <a name="summary"></a>Samenvatting

Microsoft heeft vandaag, 2 januari 2020, extra Dynamics 365-producten uitgebracht. Nieuwe producten worden ook uitgebracht op 1 februari 2020.

### <a name="details"></a>Details

Op 2 januari 2020 heeft Microsoft nieuwe producten uitgebracht voor Dynamics 365 Power Virtual Agent, biz-apps en Power Platform. Op 1 februari 2020 worden extra nieuwe producten uitgebracht voor Dynamics 365 Biz Apps en Power Platform.
...
Biz Apps en Power Platform

Op 2 januari 2020 zijn de volgende biz-apps en Power Platform uitgebracht:

- Inleiding tot aanbiedingen van studenten voor bestaande PowerApps per app-abonnement
...
- Dynamics 365 HR-gebruikers kunnen Dynamics 365 Unified Ops Extra DB/File Capacity USL-aanbiedingen aanschaffen
...
- IoT Intelligence-scenario (tenantniveau) - bevat rechten tot zes scenario's en tien machines (vereiste is gebruikersbasis voor Supply Chain/Unified Ops Management of attach-SKU)
...
Customer Insights licentie-update

Voor de volgende SKU's is het licentietype gewijzigd van Invoegvoeg naam in NIET:
...
- [Power Platform de startpagina Producten](/powerapps/maker/common-data-service/data-platform-intro#dynamics-365-and-the-common-data-service)
