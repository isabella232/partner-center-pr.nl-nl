...
Door deze naamswijziging kunnen klanten beter inzicht krijgen in de incrementele waarde die in elke aanbieding is opgenomen, zodat u de verkoopkansen voor uw accounts beter kunt positioneren.

Er worden ook naamconsistenties in de Office 365/Microsoft 365 bedrijfsplannen. Op dezelfde manier scheidt deze naamswijziging kerntoepassingen Office, die via de nieuwe Microsoft 365-apps voor bedrijven/enterprise worden verkocht, duidelijk van bredere abonnementen.
...
**Nieuwe SKU op invoerniveau:** De nieuwe SKU op invoerniveau wordt Microsoft 365 F1 en biedt waarde die is afgestemd op Firstline Workers, uitgebreide beveiliging en identiteitswaarde voor alle werkwerkers. Deze aanbieding omvat Teams, SharePoint Online, Yammer Enterprise, Stream, EMS E3 en alleen-lezen toegang voor Office Web/Mobile Apps.
...
Als onderdeel van onze voortdurende inzet voor compatibele zakelijke procedures voor klanten en partners, heeft Microsoft een geautomatiseerde validatie geïntroduceerd van alle nieuwe klantenaccounts van Education om te controleren of klanten in aanmerking komen. Sinds we de mogelijkheid voor automatische validatie hebben gestart, hebben we een toenemend aantal controleproblemen opgemerkt omdat onjuiste of ongeldige klantgegevens zijn ingevoerd. Volg de onderstaande instructies om het proces te stroomlijnen en vertragingen in het doorlichtingsproces te minimaliseren:
...
Een nieuwe Premium Messaging-SKU is beschikbaar als een invoeg-on voor Microsoft 365 en Office 365 met betaalde Teams.
...
- [Mixed Reality startpagina van de handleiding voor Mixed Reality-apps](https://dynamics.microsoft.com/mixed-reality/guides/)
...
- Als u ondersteuning nodig hebt met betrekking tot uw bewerkingen met Microsoft, neem [dan contact op met Ondersteuning.](https://partner.microsoft.com/pcv/servicerequests/create)
...
- Oorspronkelijke publicatiedatum 6 februari 2020: Communicatie vooraf
