...
- Office 365 Business Premium wordt **Microsoft 365 Business Standard**. Dit is ons belangrijkste aanbod voor SMB's, waaronder cloudservices en desktop-apps die zijn verbonden met de cloud.
...
Er zijn geen wijzigingen in prijzen, functies of bedrijfsmodellen. Er zijn ook geen naamgevingswijzigingen in Office 365 Enterprise SKU's en Microsoft 365 Enterprise SKU's. De naam van alle SKU's en aanbiedingsnamen wordt automatisch in de abonnementsnamen in de Partner Center.

### <a name="partner-opportunity"></a>Partnerkans

Met deze naamswijziging kunnen klanten meer inzicht krijgen in de incrementele waarde die in elke aanbieding is opgenomen, zodat u upsell-verkoopkansen voor uw accounts beter kunt positioneren.
...
|1 april 2020|- In de lijst met productieprijzen is de naam van de nieuwe invoerniveau-SKU gewijzigd Microsoft 365 F1 (M365 F0). - In de lijst met productieprijzen is de naam van O/M365 F1, wat eerder O/M365 F1 werd genoemd, gewijzigd in O/M365 F3. - Op onze back-up zijn klanten die tot en met 31 maart 2020 op Office 365 F1 en Microsoft 365 F1 waren, automatisch overgestappen naar Office en Microsoft 365 F3-abonnementen. - Er wordt een extra waarde in de plannen ingevuld, zoals hieronder wordt beschreven.|

**Extra waarde wordt op 1 april 2020 in uw M365 F1-, O/M365 F3-plannen ingevuld.**

### <a name="office"></a>Office:

- Microsoft Teams bevat nu volledige A/V- en vergaderrechten in F-SKU's (te zien in de productvoorwaarden van maart)
- Power Platform wordt verhoogd tot 2000 stappen en de mogelijkheid om te maken: alleen beschikbaar in M/O365 F3
- Microsoft Planner wordt standaard opgenomen in O/M365 F-SKU's

### <a name="windows"></a>Windows:

- Rights to Key Management System activation included in the default Product terms (Rechten voor activering van key managementsysteem opgenomen in de standaard productvoorwaarden)
- Rechten voor vorige versies van Windows opgenomen in de standaard productvoorwaarden
...
Zorg dat u vertrouwd bent met de lijst met preview-prijzen. Houd er rekening mee dat op 1 april 2020 de naam Microsoft 365 F0 wordt Microsoft 365 F1. Omgekeerd krijgt Microsoft 365 F1 de naam Microsoft 365 F3.

**Bekijk onze inhoud [hier voor](https://partner.microsoft.com/resources/collection/Microsoft-365-firstline-offer-updates#/) meer informatie** over de waardepropositie en maak alle marketingfuncties die u mogelijk nodig hebt om de verkoop te versnellen en nieuwe verkoopkansen te creëren.

Deel deze informatie met alle juiste contactpersonen in uw organisatie.

**Vragen?**

Neem voor verdere vragen over deze aanbiedingen contact op met uw vertegenwoordiger in het Microsoft-account team.
...
Directe factuur en indirecte provider CSP-partners die onderwijs-/academische aanbiedingen transacteren

### <a name="summary"></a>Samenvatting:

Kennisgeving voor nieuwe functionaliteit: Partners kunnen nu klantaccountgegevens corrigeren en opnieuw een doorlichtingsbericht maken voor gevallen waarin de klant is geweigerd. Bekijk de stapsgewijze instructies over hoe dit werkt in de bijgewerkte [handleiding Een onderwijsklant maken in Partnercentrum](https://assetsprod.microsoft.com/mpn/partner-center-education-customer-creation.pdf) voor de volledige details.

Als onderdeel van onze voortdurende inzet voor compatibele zakelijke procedures voor klanten en partners, heeft Microsoft een geautomatiseerde validatie geïntroduceerd van alle nieuwe inzendingen van klantenaccounts voor Education om te controleren of klanten in aanmerking komen. Sinds we de mogelijkheid voor automatische validatie hebben gestart, hebben we een toenemend aantal controleproblemen opgemerkt omdat onjuiste of ongeldige klantgegevens zijn ingevoerd. Volg de onderstaande instructies om het proces te stroomlijnen en eventuele vertragingen in het doorlichtingsproces te minimaliseren:
...
- Bekijk de **handleiding Een education-klant maken in Partner Center** en de pagina Nieuwe klant toevoegen om te documenteren wat er nodig is bij het maken van een nieuwe education-klant in Partner Center.  Beide vindt u in de onderstaande resourcegalerie.
...
Verzameling van de resourcegalerie van het CSP-programma wordt bijgewerkt: [Wijzigingen in het programma Authorized Education Partner in CSP](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/)

### <a name="change-log"></a>Wijzigingslogboek:

- Oorspronkelijke publicatiedatum: 19 december 2019
- Contact opnemen met ondersteuning als nieuwe partner die onderwijsaanbiedingen verkoopt, wordt verwijderd (niet langer vereist): 13 januari 2020
- Update van februari 2020 toegevoegd: 10 februari 2020
- Kennisgeving van de nieuwe mogelijkheid om klantaccountgegevens te corrigeren en opnieuw in te delen voor doorlichting: 10 maart 2020
...
In april 2020 breidt Microsoft het bereik en de waarde van Microsoft 365 uit.
...
Op 1 april 2020 breidt Microsoft de breedte en waarde van Microsoft 365-plannen uit, waardoor klanten meer mogelijkheden krijgen en de marktverdede markten van partners worden uitgebreid.

**Microsoft 365 F-SKU-line-up: Nieuwe aanbiedingen en herpositionering**

Microsoft introduceert een nieuwe level-entry-SKU voor Frontline Workers en biedt partners een enorme groeimogelijkheden voor gebruikers. Daarom wordt ook het oude M365 F1-plan verplaatst. Het wordt nu M365 F3 genoemd en biedt standaard extra waarde.
...
Microsoft 365 E3: met een licentie zonder toezicht kunnen Office toepassingen met serviceaccounts of andere niet-gebruikersaccounts worden gebruikt, zoals gebruikelijk bij het uitvoeren van het automatiseringsproces. We raden nog steeds aan om waar mogelijk gebruik te maken van [product-API's](https://graph.microsoft.com/) zoals Microsoft Graph automatiseringsprocessen. Deze nieuwe licentie kan echter een nieuwe optie bieden voor het werken met productiviteitsgegevens en hulpprogramma's.
...
Een nieuwe Premium Messaging-SKU is beschikbaar als een invoeg-on voor Microsoft 365 en Office 365 die betaalde Teams.

Premium Berichten maken het volgende mogelijk:

- Meldingen met onbeperkte prioriteit voor gebruikers. Teams berichten met de tag **urgent** worden ontvangers elke 2 minuten, voor een periode van 20 minuten, op de hoogte brengen.
...
- Sales Pro en Customer Service bijwerken Pro koppelen van SKU's
...
Bekijk hier de specifieke wijzigingen in het bestand met de naam 'Dynamics CSP Offer Updates–Mar 2020' [](https://partner.microsoft.com/pcv/.)
...
- Als u meer informatie wilt over de licentie-updates en de waardepropositie, moet u zich vertrouwd maken met onze gereedheidsinhoud die wordt vermeld in de Aanvullende **resources** in de vorige sectie en op PartnerSource.<br>
...
Microsoft verwijdert de vereiste Windows E3-licentie uit Microsoft Defender Advanced Threat Protection (MDATP). CSP-partners kunnen MDATP aanschaffen voor al hun ondersteunde clientapparaten, ongeacht hun eigendom Windows E3-licentie.
...
- Voor meer informatie over Microsoft Defender Advanced Threat Protection, leest u: [https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=cx-blog-mmpc](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=cx-blog-mmpc)
...
- Oorspronkelijke publicatiedatum van 6 februari 2020: Communicatie vóór de lancering
- 2 maart 2020 Bijgewerkte publicatiedatum: GA Starten (Go Live)
