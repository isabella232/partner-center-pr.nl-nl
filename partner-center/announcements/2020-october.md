...
CSP-partners die Microsoft 365 A3/A5- of Windows 10 Enterprise A3/A5-abonnementen voor hun Education-klanten hebben aangeschaft, kunnen hen nu helpen hun Windows 10 Home-apparaten te upgraden naar Windows 10 Education.

### <a name="impacted-audience"></a>Beïnvloede doelgroep

CSP-partners die een A Windows 10 Enterprise 3/A5 Microsoft 365 A3/A5- of A3/A5-abonnement voor hun Education-klanten hebben aangeschaft
...
[Windows ESU van 7](#3) jaar 2 was beschikbaar in oktober 2020. De prijzen voor het jaar 2 zijn nu beschikbaar in de prijslijst met softwareabonnementen.
...
Bekijk de [bijgewerkte vereisten en](../direct-partner-new-requirements.md#minimum-requirements) aanbevelingen voor directe factuurpartners om te evalueren hoe u een rendabeler bedrijf kunt bouwen en uitbreiden met het juiste model in het Cloud Solution Provider programma:
...
Onlangs hebben we aankondigingen gedeeld over nieuwe aanbiedingen die binnenkort in november beschikbaar zijn: Microsoft 365 Business Voice voor [non-profitorganisaties](#10) en [Microsoft 365 Business Voice](#9).
...
Microsoft start twee nieuwe CSP-promoties voor partners om de acceptatie van Teams als een oplossing voor vergadering te stimuleren. Beide promoties verminderen de frictie bij het toevoegen van audiovergaderingen aan een Microsoft 365-licentie, waardoor klanten de volledige waarde van Microsoft 365 en Teams als een oplossing voor vergaderen en aanroepen krijgen.
...
Van 1 november 2020 tot en met 30 april 2021 gelden kortingsprijzen voor nieuwe en verlengingsabonnementen van Microsoft 365 Business Voice met aanroepend abonnement en Microsoft 365 Business Voice zonder abonnement aanroepen. Microsoft 365 Business Voice met een aanroepend abonnement wordt 12 maanden een korting van 25 procent geldt en voor Microsoft 365 Business Voice zonder aanroepen van een abonnement geldt een korting van 33 procent voor 12 maanden.
   ...
   |Microsoft 365 Business Voice -promotie (zonder aanroepen van abonnement)|b71df433-6fd9-4549-886d-577f7aa06070|PZY-00019|
   |Microsoft 365 Business Voice -promotie (zonder aanroepen van abonnement)|4ba4d580-4902-42b0-8411-a27358dd5405|PZY-00016|
   |Microsoft 365 Business Voice -promotie (zonder aanroepen van abonnement)|bbfd896b-e3d4-45ba-9319-14104d400069|PZY-00018|
...
- Raadpleeg Audiovergaderingen in Microsoft 365 voor meer informatie over [audiovergaderingmogelijkheden.](/microsoftteams/audio-conferencing-in-office-365)
...
- Meer bekendheid met klanten over de waarde van het toevoegen van Business Voice- of Audiovergaderingen aan Teams.
...
## <a name="microsoft-teams-rooms-premium-sku-launch"></a><a name="7"></a>Microsoft Teams Ruimtes Premium SKU starten
...
Microsoft Teams Ruimtes Premium SKU voor Microsoft Teams via het Cloud Solution Provider (CSP)-programma is beschikbaar op 1 november 2020. 
...
- Insights en aanbevelingen: Geaggregeerde inzichten voor klanten en rapporten over de gezondheid van de ruimte, het gebruik, onlinevergaderingen en incidenttrends.
...
Microsoft kondigt met trots aan dat Microsoft Calling Plans nu beschikbaar is in de volgende nieuwe markten: Zwitserland, Frankrijk, Italië, Portugal, Zwitserland en Zwitserland.
...
Microsoft kondigt met trots aan dat vanaf 1 oktober 2020 Microsoft Calling Plans beschikbaar zijn in de volgende nieuwe markten: Frankrijk, Frankrijk, Italië, Portugal, Zwitserland en Zwitserland. De nieuwe geografische beschikbaarheid is geïntroduceerd in Commercial, Worldwide Public Sector, Non-profit en Government Community Cloud via Enterprise Agreement (EA) of Enterprise Agreement Subscription (EAS), Enrollment for Education Solutions (EES), Web Direct en CSP.
...
Microsoft-oproepplannen werden eerder beschikbaar gesteld op de volgende markten: Canada, Frankrijk, Duitsland, Ierland, Nederland, Laten zien (met alleen EA- en EES-kanaalbeschikbaarheid), Spanje, het Verenigd Koninkrijk en Verenigde Staten (met de beschikbaarheid van het belplan van derden in Australië en Japan).
...
- Een Aanroepen voor Microsoft Teams geavanceerde specialisatie bereiken 
...
- Bekijk de sectie resources van de [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).
- U vindt meer informatie over de Microsoft Teams aanbiedingen op de [blog](https://www.microsoft.com/microsoft-365/blog/2020/09/08/3-deals-meeting-calling-experiences-microsoft-teams/) of op de Office 365 [yammer-groep van de partner.](https://www.yammer.com/office365partners/)
...
Ondersteuning voor Windows 7 is beëindigd op 14 januari 2020. Hoewel veel klanten goed op weg zijn naar de implementatie van Windows 10, begrijpt Microsoft dat iedereen zich op een ander punt in het upgradeproces beeert. Met de effectieve periode van Windows 7 jaar 1 ESU eindigt op 12 januari 2021, weten we dat klanten beginnen te plannen voor volgend jaar.  
...
Met trots kondigen we de beschikbaarheid van nieuwe SKU's en waarde op 1 oktober 2020 aan om klanten te helpen de kracht van Project Cortex en Microsoft Search te benutten, zodat hun gebruikers informatie efficiënter [kunnen](https://resources.techcommunity.microsoft.com/project-cortex-microsoft-365/) vinden en beheren.  
...
SharePoint Syntex SKU's zijn beschikbaar in de prijslijsten van 1 oktober (de preview-versie van de prijslijst van 1 september weerspiegelt Intelligent Content Services). Microsoft-licentievoorwaarden kunnen nog tot 1 november 2020 verwijzen naar deze SKU onder de oude naam Intelligent Content Services.
