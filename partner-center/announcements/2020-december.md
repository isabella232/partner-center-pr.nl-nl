...
We herkennen de voortdurende impact van deze moeilijke tijden op onze partners en hun klanten. Om partners extra flexibiliteit te bieden, verlenen we een time-rollover van ongebruikte co-op-middelen uit de huidige gebruiksperiode van FY21 H1, die loopt van 1 juli tot 31 december 2021. Co-op-middelen worden als onderdeel van uw incentive-inkomsten, en kunnen worden geclaimd voor in aanmerking komende marketing-, vraaggeneratie- en gereedheidsactiviteiten.

Met deze rollover kunnen ongebruikte coöp-middelen die na het sluiten van de H1-claimperiode op uw rekening blijven, worden gebruikt voor in aanmerking komende samenwerkingsactiviteiten tijdens de fy21 H2-gebruiksperiode, die loopt van 1 januari tot 30 juni 2021.  
...
- Verbruikstarieven voor valuta's van Azure-plan
...
We willen u eraan herinneren dat vanaf **19 januari 2021** alle partners die zijn ingeschreven bij het CSP-programma, commerciële doorlopende softwarelicenties kunnen verkopen voor on-premises implementatie via CSP. Hierdoor krijgen klanten de licentieflexibiliteit die ze nodig hebben als onderdeel van hun digitale transformatie.
...
- De Partner Center van software en licentiesleutel wordt ingetrokken - zie de aankondiging [-](./2020-september.md#17) en partners zullen klanten in de toekomst aansturen om het Microsoft 365-beheer Center uitsluitend voor dit doel te gebruiken. Dit zorgt voor de veiligste en efficiëntste ervaring voor klanten. Lees meer over de Microsoft 365-beheer Center-software door het overzicht [,](https://support.microsoft.com/office/admin-center-overview-fa715fa8-6eda-456d-b177-d1c156edd1b3)algemene taken [en](/microsoft-365/admin/admin-overview/about-the-admin-center?preserve-view=true&view=o365-worldwide)mogelijkheden voor het uitvoeren van [licentiesleutels te bekijken.](https://partner.microsoft.com/resources/detail/microsoft-365-admin-center-software-key-download-pdf)
...
Onderstaande aanbiedingen staan in de aanbiedingslijstmatrix met een foutmelding. Ze zijn niet beschikbaar, er is nog geen doeldatum voor beschikbaarheid. Partners moeten deze regelitems negeren.
...
## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a>Een update van de Amerikaanse Microsoft 365 Business Voice met de aanbieding Voor oproepende plannen is binnenkort beschikbaar
...
Op 1 januari 2021 begint Microsoft met het overstappen van Amerikaanse partners en klanten naar een nieuwe Microsoft 365 Business Voice met de aanbieding Abonnement aanroepen. Er is geen actie van een partner vereist.
...
Bestaande klanten worden na hun verlengingsdatum automatisch overgestappen naar de nieuwe aanbieding. Er is geen actie vereist van partners en het vernieuwen van klanten.
...
De bestaande GET- en PUT-kwalificatie-API's worden vóór het einde van februari **2021 met pensioen gezet.** Op dat moment moet u zijn overgestappen naar de nieuwe GET- en POST Partner Center-API's om Onderwijsaanbiedingen te kunnen kopen.  
