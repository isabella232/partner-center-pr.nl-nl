...
-   De **nieuwe** [Global Promo Readiness Guide(Handleiding](https://partner.microsoft.com/resources/collection/global-promo-readiness-guide-collection#/) voor gereedheid voor wereldwijde promotie) waarin recente en toekomstige promoties worden verzameld die beschikbaar zijn voor partners en klanten.
...
3. Het extra tabblad in het werkblad met de naam Sheet1(2) is verwijderd.
...
De preview-prijslijst van juli voor op licenties gebaseerde services die zijn gepost op 1 juni 2021 bevat een typefout voor de non-profit aanbiedingen voor Office 365 E1. De prijslijst heeft ten onrechte de volgende aanbiedingen gemarkeerd als DEL (verwijdert). De prijslijst voor op licenties gebaseerde services is bijgewerkt op 4 juni 2021 om 11:00 pst met de correcties. Deze correcties zijn alleen van toepassing op:
