...
- Voor partners die nog geen nieuwe commerce-aanbiedingen hebben aangenomen, is deze wijziging afgestemd op het vorige partnerfactureringsmodel, zodat ze eenvoudig kunnen overstappen naar de nieuwe commerce-ervaring in CSP.
...
## <a name="corrections-to-july-license-based-services-price-list-preview"></a><a name="3"></a>Correcties in de preview-versie van de prijslijst voor licentieservices van juli
