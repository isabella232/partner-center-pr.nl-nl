...
**Bijwerken:** Microsoft heeft de overgang van fase 2 naar begin augustus uitgesteld omdat er aanvullende testvalidatie nodig is.

Vanaf half augustus 2021 zal Microsoft de facturering van nieuwe commerceaanbiedingen overstappen van de valuta van klantlocatie naar partnerlocatievaluta voor partners met bestaande klanten die vóór fase 1 een nieuwe commerce-aanbieding in CSP hebben aangeschaft, evenals klanten die hun tenants hebben gemaakt op of na 11 mei 2020.
...
Er zijn geen technische wijzigingen in de Microsoft API of Partner Center. Als u echter Microsoft API's of een externe leverancier van het configuratiescherm (CPV) gebruikt voor elk soort factureringsautomatisering, is er mogelijk een partneractie vereist om ervoor te zorgen dat uw commerce-systeem de wijziging van valuta kan opvangen.
...
De nieuwste Global Promo Readiness Guide, een geconsolideerde weergave van alle huidige en toekomstige promoties, is nu beschikbaar in de operations readiness-resourcegalerie. Zie actieve en toekomstige promoties en aanbiedingen in de [Global Promo Readiness Guide-verzameling](https://partner.microsoft.com/resources/collection/global-promo-readiness-guide-collection#/).

### <a name="next-steps"></a>Volgende stappen

Bekijk de nieuwste maandelijkse promotiehandleiding in de resourcegalerie Operations Readiness. Deel deze informatie met de juiste contactpersonen in uw organisatie en laat ons weten of de handleiding nuttig is door te reageren op de vraag "Was deze pagina nuttig?" vraag aan de onderkant van de pagina.
...
Er zijn drie fasen van wijziging in de vorige Azure-aanbieding. In fase 1 staan alle nieuwe Azure CSP programma-activiteiten op het nieuwe Azure-plan. De volgende richtlijnen zijn van toepassing:

- Voor alle bestaande resellerrelaties tussen partners en klanten in het CSP-programma kan de partner de vorige Azure-aanbieding blijven verhandelen en kan de klant die aanbieding blijven aanschaffen als de klant deze al eerder heeft aangeschaft.

- De vorige Azure-aanbieding is niet meer beschikbaar voor nieuwe partners die in CSP worden uitgevoerd.

- De vorige Azure-aanbieding is niet langer beschikbaar voor nieuwe nettoklanten die aankopen doen via een partner in CSP.
...
________________
## <a name="june-cloud-solution-provider-csp-community-update-and-reminders"></a><a name="6"></a>Update en Cloud Solution Provider van de CSP -community van juni
...
Nieuwe en verlengingsabonnementen van Microsoft 365 Business Voice met aanroepend abonnement en Microsoft 365 Business Voice zonder abonnement aanroepen zijn tot en met 31 december 2021 onderhevig aan kortingsprijzen. Microsoft 365 Business Voice met abonnement voor oproepen geldt een korting van 25 procent voor 12 maanden en voor Microsoft 365 Business Voice zonder aanroepen van een abonnement geldt een korting van 33 procent voor 12 maanden.
...
| Microsoft 365 Business Voice (zonder aanroepen van abonnement) voor RoW | **4ba4d580-4902-42b0-8411-a27358dd5405** | cc69a07c-8c51-457f-bb2a-f21a62d6bede |
...
1. Onjuiste prijzen in sommige valuta's.
   ...
   - Voor sommige producten in Het Russisch Hebtoe (TIJDENS) en Zuid-Koreaans won (KRW) zijn onjuiste prijzen in rekening brengen tussen 27 april 2021 en 3 juni 2021. Deze producten hadden onjuiste prijzen die zijn gecorrigeerd in de huidige permanente prijzenmodellen.
...
Office 365 E1 non-profit aanbieding(en) zijn ten onrechte gemarkeerd als DEL (deletes) in de prijslijst van juli. Op 4 juni 2021 is een bijgewerkte lijst met preview-prijzen gepubliceerd, met een rectificatie van het typefout.
...
De preview-prijslijst van juli voor op licenties gebaseerde services die zijn gepost op 1 juni 2021 bevat een typefout voor de non-profit Office 365 E1 non-profitaanbiedingen. In de prijslijst zijn de volgende aanbiedingen ten onrechte gemarkeerd als DEL (verwijdert). De prijslijst voor op licenties gebaseerde services is bijgewerkt op 4 juni 2021 om 11:00 pst met de correcties. Deze correcties zijn alleen van toepassing op:
...
De kalender voor productlancering [van](https://partner.microsoft.com/resources/collection/product-launch-calendar-collection#/) juni 2021 is nu beschikbaar in de resourcegalerie Operations-gereedheid. Bekijk hier de komende productlanceringen en aanbiedingen.
