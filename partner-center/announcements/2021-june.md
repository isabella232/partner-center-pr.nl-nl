...
**Bijwerken:** Microsoft heeft de overgang van fase 2 uitgesteld om half augustus te starten, omdat er aanvullende testvalidatie is vereist.
...
Er zijn geen technische wijzigingen in de Microsoft API of Partner Center. Als u echter Microsoft API's of een externe leverancier van het configuratiescherm (CPV) gebruikt voor elke vorm van factureringsautomatisering, is er mogelijk een actie van een partner vereist om ervoor te zorgen dat uw commerce-systeem de wijziging van valuta kan opvangen.
...
Fase 1 van de wijzigingen in Azure biedt beschikbaarheid in het CSP-programma met betrekking tot de nieuwe commerce-ervaring van kracht op 21 juli 2021.
...
- De vorige Azure-aanbieding is niet langer beschikbaar voor net-nieuwe partners die in CSP worden uitgevoerd.
...
| Microsoft 365 Business Voice (zonder aanroepend abonnement) (Canada) | **b71df433-6fd9-4549-886d-577f7aa06070** | dad393d5-5f4c-443c-95ce-240b687bd255 |
...
Office 365 E1 non-profit aanbieding(en) zijn ten onrechte gemarkeerd als DEL (deletes) in de preview-prijslijst van juli. Op 4 juni 2021 is een bijgewerkte preview-prijslijst gepubliceerd, met een rectificatie van het typefout.
