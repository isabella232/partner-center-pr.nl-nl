...
## <a name="phase-1-now-live-euefta--uk-change-of-partner-billing-currency-for-new-commerce-offers"></a><a name="15"></a> Fase 1 nu live: EU/EFTA & uk Change of Partner Billing Currency for new commerce offers
...
- Alle partners die het programma Cloud Solution Provider in de EU/EFTA-& VK
...
- Bestaande klanten kopen voor het eerst nieuwe commerce-aanbiedingen - Tenant gemaakt vóór 11 mei 2020

Vanaf 28 januari 2021 worden partners die netto nieuwe klanten hebben die een nieuwe commerce-aanbieding kopen of bestaande klanten met tenants die zijn gemaakt vóór 11 mei 2020, gefactureerd voor deze aankopen in partnerlocatievaluta.  
...
- 28 januari 2021: 
    ...
    -    Verduidelijking als het VK niet is opgenomen in de EU/EFTA, maar ze maken deel uit van de Europese regio en markt van [Microsoft](../regional-authorization-overview.md) en zullen worden beïnvloed
...
Houd er ook rekening mee dat vanaf vandaag de Partner Center-functionaliteit voor het leveren van software en licentiesleutels is ingetrokken en dat partners klanten voor dit doel naar het Microsoft 365-beheer Center moeten laten wijzen. Zie hieronder voor meer informatie en de volgende stappen.

### <a name="next-steps"></a>Volgende stappen

- Download de **prijslijst voor doorlopende CSP-software** in **de sectie Software** van de pagina Partner Center prijzen & [aanbiedingen.](https://partnercenter.microsoft.com/pcv/sales) U vindt hier een overzicht van de zojuist toegevoegde producten en geografische [gebieden.](https://partner.microsoft.com/resources/detail/software-in-csp-new-products-geos-pdf)
...
Een invoeg-on die beschikbaar is met een Microsoft 365 E5 stelt klanten in staat om hun gegevens tien jaar te kunnen opslaan. 
...
Deze programmatische aanbiedingen vervangen [](https://microsoft.sharepoint.com/teams/M365LicensingNews/SitePages/Security-and-Compliance-Promotion-for-Firstline-Workers-Update.aspx) de huidige promotie voor beveiliging en naleving die op **28 februari 2021 verloopt.** In tegenstelling tot de huidige promotie bieden de F5-invoegtoepassingen klanten meer voorspelbaarheid voor prognoses naarmate hun eerstelijnspersoneel groeit.
...
Cloud Solution Provider partners die de Noors krone gebruiken.

### <a name="details"></a>Details

Vanaf 1 maart 2021 worden de Noors krone-prijzen voor commerciële on-premises software en onlineservices gewijzigd in een andere lijn met de geldende prijsniveaus in de regio.
...
Een invoegaanbieding voor Microsoft 365, waaronder Telefoonsysteem en Abonnement voor nationale oproepen en een zelfstandig abonnement voor nationale oproepen, zal binnenkort landen selecteren.
