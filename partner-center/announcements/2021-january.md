...
- Download de **lijst met prijsinformatie voor CSP-permanente software** in de sectie **Software** van de Partner Center pagina Prijzen [& aanbiedingen.](https://partnercenter.microsoft.com/pcv/sales) Een overzicht van de zojuist toegevoegde producten en geografieën vindt u [hier.](https://partner.microsoft.com/resources/detail/software-in-csp-new-products-geos-pdf)
...
Verschillende Microsoft 365 zijn opgenomen in de prijslijstpreview in januari en zijn beschikbaar vanaf 1 februari 2021.
...
Microsoft brengt wijzigingen aan in de prijslijst voor de Indisch rupee om de prijzen voor commerciële software en onlineservices binnen India en de regio Azië af te stemmen. We publiceren meer details zodra deze beschikbaar komen. Als u in de tussentijd hulp nodig hebt, kunt u contact opnemen [Partner Center ondersteuning](https://partner.microsoft.com/support/?stage=1).
...
Binnenkort wordt een invoegaanbieding voor Microsoft 365 beschikbaar, waaronder Telefoonsysteem en Abonnement voor nationale oproepen en een zelfstandig abonnement voor nationale oproepen.
...
De gebundelde invoegaanbieding voor Microsoft 365 E1-, E3- en E5-aanbiedingen bevat Telefoonsysteem abonnement voor nationale oproepen. Bovendien is een nieuwe zelfstandige abonnementsaanbieding voor nationale oproepen alleen beschikbaar voor E5. De nieuwe aanbiedingen zijn alleen beschikbaar voor klanten in de VERENIGDE Staten, Den Staten en Canada. voor alle andere landen en gebieden blijven de bestaande wereldwijde zelfstandige SKU's en prijzen hetzelfde. 

Deze aanbiedingen zijn beschikbaar voor commerciële, student-, faculteits-, Government Community Cloud-klanten (GCC) en non-profitklanten in de V.S.,Vak 10 en Canada. Aanroepplannen zijn niet beschikbaar in een van de andere Amerikaanse gebieden.
