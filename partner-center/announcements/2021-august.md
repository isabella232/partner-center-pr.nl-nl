...
________________
## <a name="privacy-management-for-microsoft-365-launch-is-delayed"></a><a name="20"></a>Privacybeheer voor Microsoft 365 is vertraagd

### <a name="summary"></a>Samenvatting

Het privacybeheer voor Microsoft 365 startplan is gewijzigd. We werken aan een nieuwe lanceringsdatum en zullen dit binnenkort communiceren.
...
Het privacybeheer voor Microsoft 365 lancering gepland voor 1 september 2021, is vertraagd. De SKU's die in de preview-versie van de prijslijst worden gedeeld, zijn op dit moment niet beschikbaar voor bestelling.

De betrokken SKU's die zijn opgenomen in de preview-versie van de prijslijst zijn:
...
| Privacybeheer - aanvraag voor onderwerprechten (1) voor EDU  | 041a6bc1-ceff-4027-b712-cc2c12146743 | INK-00002 |
...
| Privacybeheer - aanvraag voor onderwerprechten (100) voor EDU  | d6d48446-83e9-4ed1-ace2-5a588b5b7038 | IRG-00002 |
...
Windows Server 2022, de volgende Long-Term Servicing Channel-release (LTSC), stelt klanten in staat om met vertrouwen bestaande en nieuwe bedrijfskritieke toepassingen uit te voeren op Azure, on-premises en aan de rand.

Windows Server 2022 introduceert geavanceerde beveiliging met meerdere lagen, hybride mogelijkheden met Azure en een flexibel toepassingsplatform. Als onderdeel van deze algemene beschikbaarheid brengen we beveiligde kernmogelijkheden naar Windows Server om systemen te beveiligen die workloads op Windows Server 2022 uitvoeren. Een server met beveiligde kernen bouwt voort op technologieën zoals Windows Defender System Guard en beveiliging op basis van virtualisatie om het risico van beveiligingsproblemen in firmware en geavanceerde malware te minimaliseren. De nieuwe release biedt ook beveiligde connectiviteit, met verschillende nieuwe mogelijkheden, zoals snellere en veiligere versleutelde HTTPS-verbindingen en industriestandaard SMB AES 256-versleuteling.

Windows Server 2022 verbetert het beheer van hybride servers met aanzienlijk verbeterd beheer van virtuele machines, een verbeterde gebeurtenisviewer en nog veel meer nieuwe mogelijkheden in het Windows-beheercentrum. Daarnaast bevat deze release aanzienlijke verbeteringen in Windows container, zoals kleinere afbeeldingsgrootte voor sneller downloaden, vereenvoudigde implementatie van netwerkbeleid en hulpprogramma's voor containerisatie voor .NET-toepassingen.
...
Zie [CSP-prijzen](../pricing-and-offers.md) (beschikbaar in oktober) voor meer informatie over prijzen voor Windows Server 2022.

##### <a name="q-are-there-any-changes-to-the-licensing-model-for-windows-server-2022"></a>V. Zijn er wijzigingen aangebracht in het licentiemodel voor Windows Server 2022?
...
________________
## <a name="seat-based-offers-for-integrated-sandbox-testing-in-the-new-commerce-experience"></a><a name="18"></a>Aanbiedingen op basis van seat voor geïntegreerde sandboxtests in de nieuwe commerce-ervaring
...
- Detectie en aankoop van nieuwe commerceproducten en -SKU's, waaronder side-by-side detectie van traditionele product-SKU's op basis van licenties en nieuwe commerce-producten
...
- Ondersteuning voor factureringsplannen voor jaarlijkse, maandelijkse en eenvoudig betalen
- Abonnementslevenscyclusbeheer met ondersteuning voor de respijtperiode
...
- SKU-upgrades voor de volledige hoeveelheid voor de termijn
...
- Prijstransparantie 
- Automatische-seat opnieuw toewijzen voor SKU-overgangen voor volledige hoeveelheid
...
- Prijslijstvoorbeeld en ondersteuning voor Europese regionale klant valuta's
- Telco biedt het inschakelen van betalen naar uitval
- Ondersteuning voor promoties, inclusief nieuwe API's
- Afdwinging van invoegverzoeken 
- Uitbreiding van annuleringsvenster van 24 tot 72 uur (met prognose)
- Migratiemogelijkheden van traditionele abonnementen naar nieuwe handel, inclusief API-ondersteuning
- Op de gemiddelde termijn schakelen tussen factureringsplannen zonder de bestaande termijn opnieuw in te voeren
...
- De CSP-handleiding voor bewerkingen voor Microsoft 365, Dynamics 365, Power Platform en Windows 365 in de nieuwe commerce-ervaring is beschikbaar om te bekijken in de galerie Operations [Readiness](https://partner.microsoft.com/resources/collection/new-commerce-experience-for-csp-seat-based-offers#/) op 1 september 2021.
- Bekijk de resources die worden beschreven in de handige [gereedheidskaart](https://partner.microsoft.com/resources/detail/readiness-map-new-commerce-experienceseat-based-offers-pdf).
...
Voor ondersteuning plaatst u een bericht op de conversaties op de [Partnercentrum-SDK API-Yammer of](https://www.yammer.com/cloudpartnercommunity/#/threads/inGroup?type=in_group&feedId=6589502) maakt u een ondersteuningsticket aan.
...
________________
## <a name="invoice-structure-update-for-the-us-puerto-rico-and-canada"></a><a name="17"></a>Update van factuurstructuur voor de VERENIGDE Staten, Canada en Canada
...
Partners die werken in het Cloud Solution Provider (CSP)-programma in de VERENIGDE Staten, Transcript Transcript en Canada

### <a name="details"></a>Details

Vanaf 29 augustus 2021 worden de volgende updates aangebracht voor de moderne facturen van partners die in het CSP-programma in de VERENIGDE Staten, Den Staten en Canada werken.

#### <a name="us-puerto-rico-and-canada"></a>VS, Canada en Canada
...
1. Belasting van Deen (waar JurisdictionLevel = TERRITORY)
2. Fiscaal belasting (waar JurisdictionLevel = COUNTY)
...
Voor vragen over deze aanbiedingen raadpleegt u uw relevante Microsoft Partner Verbinding maken community's.

________________
## <a name="now-live-new-commerce-experience-in-csp-for-azure-expanding-to-government-community-cloud-gcc"></a><a name="16"></a>Nu live: Nieuwe commerce-ervaring in CSP voor Azure die wordt uitgebreid naar Government Community Cloud (GCC)
...
Fase 2 van de Europese Unie (EU)/EfTA (Europese Free Trade Association) en de wijziging van partnerfactureringsvaluta voor nieuwe handelsaanbiedingen in het Verenigd Koninkrijk (VK) is nu live.
...
Neem contact op met de Partner Center (aanmelden is vereist) [voor](https://partner.microsoft.com/dashboard/support/referrals/servicerequests?category=referrals) vragen met betrekking tot deze melding.
...
Elke fase van het nieuwe commercetraject biedt nieuwe mogelijkheden, aanbiedingen, functies en voordelen. Het is twee jaar geleden begonnen met de nieuwe commerce-ervaring voor CSP met Microsoft Azure (het eerste Microsoft-aanbod dat werd geïntroduceerd op het nieuwe commerceplatform), gevolgd door gereserveerde instanties van Azure en, meest recent, doorlopende softwareaanbiedingen.
...
- Nieuwe aanbiedingen voor de maandelijkse termijn met een prijs-premium voor klanten die flexibiliteit op termijn en aantal seat nodig hebben.
- Aanbiedingen voor jaarlijkse termijn met concurrerende prijzen voor stabiele, langetermijnklanten.
- De optie om korte- en langetermijnaanbiedingen te combineren voor klanten met schommelingen in seizoensgebonden of zakelijk volume.
...
- Een nieuwe set communicatieaanbiedingen (momenteel gepland voor oktober) die het verbruik van telco-service achteraf in rekening brengen, als voorloper voor het uitrollen van deze optie voor andere nieuwe aanbiedingstypen in latere releases.
...
*Windows 365 is beschikbaar in de nieuwe commerce-ervaring voor de aankoop van ondernemingen in september 2021 (bekijk de licentieverlening voor de Windows [](https://aka.ms/licensingwindows365) [365 L100-stapel](https://partner.microsoft.com/resources/detail/windows-365-licensing-l100-deck-pdf) voor meer informatie en aanvullende informatie die hier half september wordt geplaatst) en in oktober 2021 in CSP.* De nieuwe commerce-ervaring in CSP biedt Windows 365 alleen via de nieuwe aanbieding voor de maandelijkse termijn, waarmee klanten dit nieuwe product zonder langetermijnver commitment kunnen ervaren en het aantal gebruikers maandelijks kunnen aanpassen aan de prijs per gebruiker. Ten laatste worden nieuwe Windows 365-functies en toekomstige verbeteringen alleen beschikbaar gesteld op de nieuwe commerce-breedteaanbieding in CSP.
...
Partners kunnen een gefaseerd aanpak hanteren voor de nieuwe handel en kunnen tot maart 2022 blijven verkopen in het vorige CSP-platform. Belangrijke toekomstige mijlpalen (onderhevig aan wijziging):

- Maart 2022: Nieuwe abonnementsorders en verlengingen zijn alleen mogelijk voor de nieuwe commerce-ervaring.
...
Met deze nieuwe functies kan Microsoft enkele populaire mogelijkheden en aanbiedingstypen van andere licentieprogramma's toevoegen aan nieuwe handel en een end-to-end set functies leveren, waarmee de suite met Microsoft-cloudaanbiedingen in nieuwe handel wordt afgerond.
...
Wijzigingen in prijzen voor cloudklanten van de Amerikaanse overheid worden in de loop van de jaren gefaseerd doorgevoerd, in overeenstemming met de bestaande vereisten. Er is op dit moment geen prijswijziging voor onderwijs- of consumentenproducten.
...
Ga voor meer informatie over deze aanstaande wijzigingen naar de Operations Readiness-galerie in [Update to our commercial pricing for Microsoft 365](https://partner.microsoft.com/resources/collection/update-to-our-commercial-pricing#/).

### <a name="questions"></a>Vragen?

Als u vragen hebt, kunt u contact Regional Operations Center met het Call Logging Tool (CLT) op [clt.partners.extranet.microsoft.com/CLT](https://clt.partners.extranet.microsoft.com/CLT) of [via explore.ms](https://www.explore.ms/). Volg het standaard CLT-proces nauwkeurig, zodat we uw query zo snel mogelijk kunnen oplossen.
...
- [Overzicht: Hulpprogramma voor verbeterde overgang van abonnementen](https://partner.microsoft.com/resources/detail/overview-enhanced-subscriptions-transition-tool-pdf)
...
In de maandelijkse [CSP-communityverzameling](https://partner.microsoft.com/resources/collection/august-2021-csp-partner-community-content#/)vindt u:
...
Als u vragen hebt over het PAM-team, kunt u contact op met uw vertegenwoordiger in Microsoft-account team.
...
#### <a name="update-on-windows-365-trials"></a>Bijwerken in Windows 365-proefversies

Vanwege een aanzienlijke vraag hebben we de capaciteit voor Windows 365 proefversies bereikt, dus worden nieuwe proefversies onderbroken. Klanten kunnen [zich aanmelden om](https://go.microsoft.com/fwlink/?linkid=2165147) een melding te ontvangen wanneer proefabonnementen worden hervat of hier Windows 365 [kopen.](https://www.microsoft.com/windows-365?ms.url=w365&rtc=1)
...
Opvallende functies zijn onder andere:
...
**Ik begrijp dat elke persoon die Windows 365 Business met Windows Hybrid Benefit gebruikt, ook een geldige kopie van de Windows 10/11-Pro moet hebben geïnstalleerd op hun primaire werkapparaat.**
...
|:------------------------------------------- |:--------------------------------------- |
| Windows 365 Business 1 vCPU, 2 GB, 64 GB (Windows Hybrid Benefit) | 5f3a7cd2-c76f-4b21-9ddc-f48f09869cf6 |
| Windows 365 Business 2 vCPU, 4 GB, 128 GB (Windows Hybrid Benefit) | 7612386a-d98d-4110-94b8-554bd612a5ab |
...
| Windows 365 Business 8 vCPU, 32 GB, 512 GB (Windows Hybrid Benefit) | aca639ae-ae81-4298-a76a-094b6880913b |
