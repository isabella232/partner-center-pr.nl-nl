...
- **Altijd gereed en bijgewerkt:** Gestreamd vanuit de cloud en met u mee op reis, Windows 365 is altijd gereed en altijd bijgewerkt, waar u ook bent, op elk apparaat waarop u wilt werken. Het is een eenvoudige en veelzijdige Windows die wordt geleverd door de Microsoft-cloud.

- **Persoonlijk en vertrouwd:** Windows 365 is gepersonaliseerd en vertrouwd met al uw instellingen en inhoud, dus wanneer u terug naar uw cloud-pc gaat, is dit precies waar u deze hebt gelaten.
...
- Neem op 18 augustus deel aan een webinar over [go-to-market](https://aka.ms/Windows365PartnerWebinar) voor partners voor meer informatie over de partnerkans met Windows 365.
...
We brengen enkele updates aan in de prijslijsten van het Azure-plan Partner Center om ervoor te zorgen dat de items in de prijslijst synchroon zijn met wat er beschikbaar is voor Partner Center.
...
We brengen enkele updates aan in de prijslijsten van het Azure-plan Partner Center om ervoor te zorgen dat de items in de prijslijst synchroon zijn met wat er beschikbaar is voor Partner Center. Dit moet vanaf 2 september 2021 worden aangepakt. Deze wijzigingen zijn alleen van toepassing op prijslijsten voor azure-reserveringen voor nieuwe commerce-reserveringen.
...
Voor sommige nieuw beschikbare Windows 365-aanbiedingen die vanaf augustus 2021 beschikbaar zijn, is een speciale attestation vereist vóór de aankoop.
...
**Ik begrijp dat elke persoon die Windows 365 Business met Windows Hybrid Benefit gebruikt, ook een geldige kopie van de Windows 10/11-Pro moet hebben geïnstalleerd op het primaire werkapparaat.**
...
| Windows 365 Business 2 vCPU, 8 GB, 128 GB (met Windows Hybrid Benefit) | d5623401-b8e0-429f-86df-29b6efdf4d95 |
...
| Windows 365 Business 4 vCPU, 16 GB, 128 GB (met Windows Hybrid Benefit) | 46448c4c-8b12-4ea1-9be7-76b35d69bcf5 |
