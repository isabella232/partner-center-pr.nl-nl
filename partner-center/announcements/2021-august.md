...
- **Altijd gereed en bijgewerkt:** Gestreamd vanuit de cloud en met u meegereisd, Windows 365 is altijd gereed en altijd bijgewerkt, waar u ook bent, op elk apparaat waarop u wilt werken. Het is een eenvoudige en veelzijdige Windows door de Microsoft Cloud wordt geleverd.
...
Vanwege een aanzienlijke vraag hebben we de capaciteit voor Windows 365 proefversies bereikt, dus onderbreken we nieuwe proefversies. Klanten kunnen [zich aanmelden om](https://go.microsoft.com/fwlink/?linkid=2165147) een melding te [](https://www.microsoft.com/windows-365?ms.url=w365&rtc=1) ontvangen wanneer proefabonnementen worden hervat, of ze kunnen hier Windows 365 kopen.
