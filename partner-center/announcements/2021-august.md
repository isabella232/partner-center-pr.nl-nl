...
________________
## <a name="privacy-management-for-microsoft-365-launch-is-delayed"></a><a name="20"></a>Privacybeheer voor Microsoft 365 wordt vertraagd
...
- Upgrades voor SKU's voor de midterme volledige hoeveelheid
...
- De CSP-handleiding voor bewerkingen voor Microsoft 365, Dynamics 365, Power Platform en Windows 365 in de nieuwe commerce-ervaring is vanaf 1 september 2021 beschikbaar in de galerie Operations [Readiness.](https://partner.microsoft.com/resources/collection/new-commerce-experience-for-csp-seat-based-offers#/)
...
GCC partners die via het CSP-programma werken
...
Fase 2 van de Europese Unie (EU)/Europese Free Trade Association (EFTA) en de wijziging van de partnerfactureringsvaluta voor nieuwe commerceaanbiedingen in het Verenigd Koninkrijk (VK) is nu live.
...
Er zijn geen technische wijzigingen in de Microsoft API of Partner Center. Als u echter Microsoft API's of een externe leverancier van het configuratiescherm (CPV) gebruikt voor factureringsautomatisering, is er mogelijk een partneractie vereist om ervoor te zorgen dat uw commerce-systeem de wijziging van valuta kan opvangen.
...
- 23 augustus 2021:
    - Fase 2 is nu live en wordt in batches voor partners uitgerold in de week van 23 augustus 2021.
...
Microsoft is op een transformatietraject met haar commerce-ervaring: een investering voor meerdere fases en meerdere jaren. De nieuwe commerce-ervaring voor het CSP-programma (Cloud Solution Provider) is gebouwd op basis van de basismogelijkheden die CSP de basis hebben gemaakt voor partners die cloudoplossingen met toegevoegde waarde verkopen. Met nieuwe commerce kunnen partners unieke serviceaanbiedingen bieden aan klanten, ongeacht hoe klanten deze kopen, zodat ze digitaal kunnen transformeren. En partners kunnen hun bedrijf uitbreiden met continue verkoop en beheerde services en tegelijkertijd de kosten verlagen.

Elke fase van het nieuwe commercetraject brengt nieuwe mogelijkheden, aanbiedingen, functies en voordelen met zich mee. Het is twee jaar geleden begonnen met de nieuwe commerce-ervaring voor CSP met Microsoft Azure (het eerste Microsoft-aanbod dat is geïntroduceerd op het nieuwe commerceplatform), gevolgd door Gereserveerde instanties van Azure en, meest recent, permanente softwareaanbiedingen.
...
*Windows 365 is beschikbaar in de nieuwe commerce-ervaring voor de aankoop van ondernemingen in september 2021 (bekijk de licentieverlening voor [Windows 365 L100](https://partner.microsoft.com/resources/detail/windows-365-licensing-l100-deck-pdf) voor meer informatie en aanvullende informatie die wordt gepost op Licensing [is evolving](https://aka.ms/licensingwindows365) in mid september) en in CSP in oktober 2021.* De nieuwe commerce-ervaring in CSP biedt Windows 365 alleen via de nieuwe aanbieding voor de maandelijkse termijn. Hierdoor kunnen klanten dit nieuwe product zonder langetermijnvernieuwing ervaren en het aantal gebruikers maandelijks aanpassen met prijzen per gebruiker. Ten laatste worden nieuwe Windows 365-functies en toekomstige verbeteringen alleen beschikbaar gesteld op de nieuwe commerce-breedteaanbieding in CSP.
...
We hebben ook de uitbreiding aangekondigd van een onbeperkte **inbel-inbel** voor onze betaalde suite voor ondernemingen, bedrijven, frontline en overheid, zodat gebruikers vanaf vrijwel elk apparaat kunnen inbellen en deelnemen aan een Teams-vergadering. De wijziging is van invloed op:
...
- Lees de blogpost: [Nieuwe prijzen voor Microsoft 365](https://aka.ms/M365PriceUpdate)
...
Terwijl we werken aan een oplossing, wordt partners aangeraden om GGWA-aanbiedingen af te lossen via het Open License-programma. Meer kennisgeving wordt gedaan zodra een oplossing is toegepast, naar verwachting vóór 31 december 2021.
...
#### <a name="update-on-windows-365-trials"></a>Update op Windows 365-proefversies

Vanwege een aanzienlijke vraag hebben we de capaciteit voor Windows 365 proefversies bereikt, dus onderbreken we nieuwe proefversies. Klanten kunnen [zich aanmelden](https://go.microsoft.com/fwlink/?linkid=2165147) om een melding te ontvangen wanneer proefabonnementen worden hervat of Windows 365 vandaag nog kopen op Welkom bij uw [Windows 365 Cloud PC.](https://www.microsoft.com/windows-365?ms.url=w365&rtc=1)
