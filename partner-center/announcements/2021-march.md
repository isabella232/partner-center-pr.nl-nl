...
## <a name="readiness-changes-to-the-cloud-solution-provider-csp-customer-address-validation-api-going-live-in-june-testing-capability-now-available"></a><a name="18"></a>Gereedheid: wijzigingen in de validatie-API van Cloud Solution Provider -klantadres (CSP) die in juni live gaat; testmogelijkheid nu beschikbaar
...
Om partners en klanten te helpen hun bedrijf te runnen op basis van vertrouwen, nodigen we partners uit om wijzigingen in de Adres-API valideren te testen voor alle landen over de hele wereld.
...
Microsoft wordt uitgevoerd op vertrouwen. We zetten ons in voor een compatibele, veilige en veilige methode voor validatie van klantadressen voor het transacteren van klantabonnementen in het CSP-programma. Vanaf 31 maart 2021 hebben we wijzigingen in de Adres-API valideren geïntroduceerd die we partners hebben uitgenodigd om te testen, voordat we live gaan met de wijzigingen in juni 2021.

Wijzigingen zijn alleen van invloed op de ADRES-API valideren. Api's voor klant- en update-factureringsprofiel maken worden niet beïnvloed.
...
Als u ondersteuning nodig hebt voor uw bewerkingen met Microsoft, kunt u contact op met uw Yammer-groep voor partnerondersteuning.
...
Deze nieuwe ervaring is momenteel beschikbaar als preview-versie en beheerders kunnen deze ervaring activeren door de schakelknop in de rechterbovenhoek in de klassieke EAC te selecteren. Ze kunnen ook naar het nieuwe EAC navigeren door de banner Nu proberen te selecteren die op alle pagina's wordt weergegeven.
...
- Persoonlijke dashboards om de productiviteit te verhogen.
...
Partners die aan de criteria voldoen, moeten de bedrijfsregistratie-id van een klant (ook wel de **INN** van de organisatie van de klant genoemd) en het telefoonnummer indienen wanneer ze nieuwe klanten onboarden of bestaande klantgegevens wijzigen.   Deze partners kunnen ook een optionele **middelste naam** voor de klant invoeren.
...
________________
## <a name="corrections-made-to-march-1-2021-perpetual-software-price-list"></a><a name="14"></a>Correcties aangebracht in de lijst met doorlopende softwareprijzen van 1 maart 2021
...
De prijslijst voor permanente software die is gepost op 1 maart 2021 bevatte markten die daar niet hadden mogen zijn. De prijslijst voor doorlopende software is bijgewerkt op 17 maart 2021 met de correcties. Deze correcties waren alleen van toepassing op:

- Product-id: DF77X4D43RKT 
- Productnaam: Windows 10 Home naar Pro Upgrade voor Microsoft 365 Business
- Verwijderde of niet-ondersteunde markten: AE, AF, AL, AM, AO, BA, BB, BD, WANT, BM, BN, BO, BR, BS, BW, BY, BZ, CI, CL, CM, CO, CR, CW, DO, DZ, EC, EG, ET, FJ, FO, GE, GH, GT, HN, IL, IN, IQ, JM, JO, KE, KG, KN, KW, KY, KZ, LB, LY, MA, MC, MD, ME, MN, MO, MU, NA, NG , NI, NP, OM, PA, PE, PH, PK, PR, PY, QA, RS, RU, RW, SG, SN, SV, TH, TJ, TM, TN, TT, TZ, UA, UG, UY, UZ, VE, VN, YE, ZM, ZW
...
Nieuwe [resource- en bewerkingstypen toegevoegd voor](https://docs.microsoft.com/partner-center/develop/auditing-resources) het ondersteunen van het scenario voor de directory-rol van de klant.
...
________________
## <a name="csp-commercial-marketplace-offer-and-fy21-csp-incentives-for-eligible-offers"></a><a name="12"></a>Commerciële CSP-marketplace-aanbieding en FY21 CSP-incentives voor in aanmerking komende aanbiedingen
...
Blijf meer te weten over deze aanbieding voor commerciële marketplace voor CSP hieronder en neem vandaag nog contact op met uw klanten om de juiste aanbiedingen te vinden om hun succes en digitale transformatie mogelijk te maken.
...
- De catalogus van de commerciële marketplace verkennen in [Partner Center](https://docs.microsoft.com/partner-center/csp-commercial-marketplace-discover) [of Azure Portal](https://ms.portal.azure.com/#home)
...
- Contact op met ISV's die u wilt gebruiken om zaken te doen
...
________________
## <a name="power-bi-premium-offer-naming-and-prerequisite-update"></a><a name="11"></a>Power BI Premium naamgeving van de aanbieding en de vereiste update
...
Partners kopen Microsoft 365 F3 in GBPs of EUR tussen 1 maart en 17 maart 2021 via het programma Cloud Solution Provider (CSP).

### <a name="details"></a>Details

Microsoft heeft onjuiste prijzen voor de Microsoft 365 F3 opgelost. De onjuiste prijzen waren voor GBPs en EUR en alleen voor aanbiedingen die zijn aangeschaft tussen 1 maart en 17 maart 2021. De beïnvloede aanbiedingen en valuta's worden hieronder vermeld. 

| Naam van aanbieding | Valuta | Aanbiedings-id | Materiaal-id |
| ------ |----------- |----------- |----------- |
| Microsoft 365 F3 (<6>) | GBP | 57b722c2-c435-4bfb-9bc8-80509213a13a | AAD-11626 |
...
________________
## <a name="update-to-cloud-solution-provider-csp-program-evolution-and-open-license-program-changes"></a><a name="8"></a> Bijwerken naar Cloud Solution Provider programma-ontwikkeling (CSP) en wijzigingen in het Open License-programma
...
Er worden nieuwe commerciële en doorlopende softwareaanbiedingen voor de publieke sector beschikbaar voor het Cloud Solution Provider-programma (CSP), samen met wijzigingen in het Open Licensing-programma.
...
- 7 juli 2021: Twee commerciële aanbiedingen, Get Genuine Windows en Visual Studio Professional, en openbare sectoraanbiedingen (overheid, onderwijs en non-profit – [zie](./2020-december.md#9)aankondiging ) worden toegevoegd aan de prijslijst voor door CSP voortgezette software.  De prijslijst vindt u in de sectie Software van de pagina [Sell > Pricing & Offers](https://partnercenter.microsoft.com/pcv/sales) in Partner Center en wordt op deze datum opnieuw gepubliceerd.
...
- Ontwikkeling van het CSP-programma: Bekijk de [permanent software in Cloud Solution Provider gereedheidsmateriaal](https://partner.microsoft.com/resources/collection/software-in-csp#/) voor het programma. Gebruik deze [gereedheidskaart om](https://partner.microsoft.com/resources/detail/software-in-csp-readiness-map-pdf) snel de juiste informatie voor uw rol te vinden.

- Wijzigingen in het Open License-programma: Controleer de [ontwikkeling van het CSP-programma en het open-licentieprogramma om](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/) de gereedheidsmaterialen te wijzigen. Gebruik deze [gereedheidskaart om](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf) snel de juiste informatie voor uw rol te vinden.
...
_______________
## <a name="update-to-a-previous-announcement-premium-assessments-an-add-on-to-compliance-manager"></a><a name="7"></a>Update naar een eerdere aankondiging: Premium Assessments, een invoeg-on voor Compliance Manager
...
________________
## <a name="expanding-the-new-commerce-experience-in-the-cloud-solution-provider-csp-program-for-azure-to-russia"></a><a name="5"></a>De nieuwe commerce-ervaring in het Cloud Solution Provider (CSP)-programma voor Azure naar Rusland uitbreiden
...
Alle Cloud Solution Provider (CSP)-partners die softwareorders voor permanente abonnementen en serverabonnementen uitvoeren via Partner Center

### <a name="details"></a>Details

In reactie op feedback van partners geven we opnieuw aan Partner Center mogelijkheid om software- en licentiesleutels voor permanente en serverabonnementssoftwareorders te verkrijgen. Deze wordt hersteld naar de vorige staat voordat deze wordt verwijderd op 19 januari 2021. (Zie de [aankondiging](2020-september.md#17).)
...
Bekijk de volgende bronnen voor gebruiksinstructies en belangrijke richtlijnen voor het distribueren van softwaresleutels:
...
Als onderdeel van onze gedeelde toezegging voor groei, is **co-verkoop** met Microsoft het pad voor u om ontdekt te **worden,** uw expertise te leveren en uw klantenvoetafdruk voor positieve klantresultaten uit te breiden. Met een gemiddelde deal die **3,5** keer sneller is dan normaal, kunt u met het beheer van uw ervaring voor co-verkoop in Partner Center verkopen via de directe klant, partner en Microsoft-verkoperkanalen en uw hele verwijzingspijplijn op één locatie beheren.
...
- **Vooraf validatie van geschiktheid** voor oplossingen die in aanmerking komen voor een incentive en om te voldoen aan de criteria van het ISV Connect-programma, vereenvoudigt u het goedkeuringsproces en het definitieve bewijs van uitvoering (POE) attestation.
...
- [Deal migration feature](../psc-to-pc.md) (Zie de sectie **PSC Deals migration(Migratie van PSC-deals).)**
...
Op 1 april 2021 zal Microsoft verschillende nieuwe producten en aanbiedingen voor het Cloud Solution Provider (CSP)-programma lanceren.
...
| Power BI Premium Per gebruiker Add-On for Students | cf62d70d-5af5-422a-bda8-97936402ac8e | 
| Power BI Premium per gebruiker Add-On (non-profit personeel prijzen) | 31c03289-47ab-4ab0-8df1-03742c127ac6 | 

**UsL geo- en segmentuitbreiding voor Customer Voice en Marketing**

Als vervolg op de lancering van december 2020 zijn de USL-aanbiedingen van Dynamics 365 Customer Voice en Marketing gewijzigd om nieuwe landen en meer non-profit- en onderwijs-SKU's toe te voegen.
...
Microsoft Universeel afdrukken vanaf 1 maart 2021 beschikbaar voor transact binnen bepaalde suite Microsoft 365 suites en als zelfstandige invoegvoeging.
