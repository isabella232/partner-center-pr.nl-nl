...
## <a name="readiness-changes-to-the-cloud-solution-provider-csp-customer-address-validation-api-going-live-in-june-testing-capability-now-available"></a><a name="19"></a>Gereedheid: wijzigingen in de validatie-API van Cloud Solution Provider -klantadres (CSP) in juni live gaan; testmogelijkheid nu beschikbaar
...
Wijzigingen zijn alleen van invloed op de ADRES-API valideren. Api's voor klant- en updateprofiel maken worden niet beïnvloed.
...
________________
## <a name="corrections-made-to-march-1-2021-perpetual-software-price-list"></a><a name="15"></a>Correcties aangebracht in de lijst met doorlopende softwareprijzen van 1 maart 2021
...
- Verwijderde of niet-ondersteunde markten: AE, AF, AL, AM, AO, BA, BB, BD, FACEBOOK, BM, BN, BO, BR, BS, BW, BY, BZ, CI, CL, CM, CO, CR, CW, DO, DZ, EC, EG, ET, FJ, FO, GE, GH, HN, IL, IN, IQ, JM, JO, KE, KG, KN, KW, KY, KZ, LB, LY, MA, MC, MD, ME, ME,  MN, MO, MU, NA, NG, NI, NP, OM, PA, PE, PH, PK, PR, PY, QA, RS, RU, RW, SG, SN, SV, TH, TJ, TM, TN, TT, TZ, UA, UG, UY, UZ, VE, VN, YE, ZM, ZW
...
- [Cloud Solution Provider voor directe factuur partner incentive resources](https://partner.microsoft.com/asset/collection/cloud-solution-provider-direct-partner-incentive-resources#/)
...
Partners die Microsoft 365 F3 in GBPs of EURO aanschaffen tussen 1 maart en 17 maart 2021 via het programma Cloud Solution Provider (CSP).
...
________________
## <a name="update-to-cloud-solution-provider-csp-program-evolution-and-open-license-program-changes"></a><a name="9"></a>Bijwerken naar Cloud Solution Provider (CSP)-programmaontwikkeling en wijzigingen in het Open License-programma
...
- 7 juli 2021: Twee commerciële aanbiedingen, Get Genuine Windows en Visual Studio Professional, en aanbiedingen voor de publieke sector (overheid, onderwijs en non-profit – zie aankondiging [)](./2020-december.md#9)worden toegevoegd aan de prijslijst voor door de CSP voortgezette software.  De prijslijst vindt u in de sectie Software van de pagina [Sell > Pricing & Offers](https://partnercenter.microsoft.com/pcv/sales) in Partner Center en wordt op deze datum opnieuw gepubliceerd.
...
Met deze mogelijkheid kunt u rapportagequery's en -sjablonen definiëren op basis van uw behoeften, een planning instellen en tijdige en betrouwbare rapporten krijgen op geplande intervallen.
...
In reactie op feedback van partners geven we opnieuw aan Partner Center mogelijkheid om software- en licentiesleutels te verkrijgen voor permanente en serverabonnementssoftwareorders. Deze wordt hersteld naar de vorige staat voordat deze wordt verwijderd op 19 januari 2021. (Zie de [aankondiging](2020-september.md#17).)
...
- [Partner Center New Commerce Operations Guide (Zie](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) de sectie Guidance on Software Key Distribution(Richtlijnen voor distributie **van softwaresleutels))**
...
Microsoft Universeel afdrukken vanaf 1 maart 2021 beschikbaar voor transact binnen bepaalde suite Microsoft 365 suites en als zelfstandige invoegactie.
...
Lees meer over de prijslijst en het Universeel afdrukken [overzicht](/universal-print/fundamentals/universal-print-whatis). Deel deze informatie met alle juiste contactpersonen in uw organisatie.
