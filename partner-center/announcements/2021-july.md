...
Als u vragen hebt over of meer informatie nodig hebt over de uitvoering van software in CSP, raadpleegt u onze nieuwste asset, de handleiding voor bestellen en afhandeling [via Partner Center](https://partner.microsoft.com/resources/detail/guide-to-ordering-and-fulfillment-through-partner-center-pdf).
...
#### <a name="open-license-program-retirement"></a>Buitentreding van het licentieprogramma openen
...
- [Microsoft Open License-programma wijzigt kennisgeving op Microsoft Licensing News:](https://www.microsoft.com/licensing/news/microsoft-open-license-program-changes?rtc=1)meer informatie over de wijzigingen in het Open License-programma en de licentieopties. Zie ook het gerelateerde Open License-programma wijzigt gereedheidsmaterialen op de [website van de Microsoft-partner.](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/)
...
1. Voorloopdatums voor de certificeringen van uw team: controleer uw Gebruikersvaardighedenrapport of Partner Center Insights Training Report om de vervaldatums voor certificeringen te identificeren die binnenkort worden verwacht.
