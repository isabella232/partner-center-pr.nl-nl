...
- **Altijd gereed en bijgewerkt**
    ...
    Wanneer Windows 365 vanuit de cloud wordt gestreamd en met u meereist, is het altijd klaar en altijd bijgewerkt, waar u ook bent, op elk apparaat waarop u wilt werken. Het is een eenvoudige en veelzijdige Windows die wordt geleverd door de Microsoft-cloud.
...
| Ophalen <br> /v1/customers/{customer_id}/subscribedskus | [Een lijst met beschikbare licenties verkrijgen - Partner Center app-ontwikkelaar - Microsoft Docs](/partner-center/develop/get-a-list-of-available-licenses) |
...
Als u vragen hebt of meer informatie nodig hebt over de uitvoering van software in CSP, raadpleegt u onze nieuwste asset, de handleiding voor het ordeeren en in uitvoering [via Partner Center](https://partner.microsoft.com/resources/detail/guide-to-ordering-and-fulfillment-through-partner-center-pdf).
...
### <a name="next-steps"></a>Volgende stappen
Bekijk de resources over dit onderwerp en deel deze met de juiste belanghebbenden in uw organisatie. [Het inschakelen van extern werk en nieuwe scenario's met Microsoft 365 E3 - Microsoft Tech Community](https://techcommunity.microsoft.com/t5/microsoft-365-blog/enabling-remote-work-and-new-scenarios-with-microsoft-365-e3/ba-p/2118541/).
...
________________
## <a name="readiness-changes-to-the-cloud-solution-provider-csp-customer-address-validation-api-to-go-live-on-july-13-2021"></a><a name="8"></a>Gereedheid: wijzigingen in de validatie-API voor klantadressen van Cloud Solution Provider (CSP) om live te gaan op 13 juli 2021
...
U kunt de certificeringen van uw organisatie altijd weergeven in uw Partner Center-dashboard, maar u kunt nu ook de vervaldatums bekijken in zowel het rapport gebruikersvaardigheden als het Partner Center Insights Training Report. Met deze updates hebt u de controle over het vernieuwingsproces voor certificering voor uw organisatie. Lees verder voor meer informatie over het vinden van de rapportage-updates en hoe u hiervan kunt profiteren.
...
Met deze updates kunt u snel actie ondernemen en uw werknemers eraan herinneren hun certificeringen te vernieuwen, waarbij zowel hun referenties als de status van uw MPN-programma actief blijven.

Hoe werkt het nieuwe vernieuwingsproces voor certificering?  

- In plaats van naar een testcentrum te gaan en te betalen voor het opnieuw afleggen van de certificeringsexamens, gaan uw werknemers naar Microsoft Learn en slagen ze voor een gratis certificeringsvernieuwingsevaluatie die ze test op de nieuwste technologie-updates.
...
1. Voorloop de vervaldatums voor de certificeringen van uw team: lees uw Gebruikersvaardighedenrapport of Partner Center Insights Training Report om de vervaldatums voor certificeringen te identificeren die binnenkort worden verwacht.
...
Zie het tabblad Promotie-SKU's in dynamics 365 Cloudmigratie promotion and [retired](https://partner.microsoft.com/resources/detail/dynamics-365-cloud-promotion-retired-skus-xls)SKU's Excel file ) voor een volledige lijst met de SKU's.
