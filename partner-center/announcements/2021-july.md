...
Meer informatie over de exportfunctie kunt u bekijken in onze handleiding [Verwijzingsgids Insights in Partner Center.](../referral-insights.md#export)

________________
## <a name="new-commerce-experience-in-csp-for-azure-expanding-to-government-community-cloud-gcc"></a><a name="16"></a>Nieuwe commerce-ervaring in CSP voor Azure uitgebreid naar Government Community Cloud (GCC)
...
- Partners die zijn ingeschreven bij Microsoft Commerce Incentives komen nog steeds in aanmerking voor incentives die betrekking hebben op de nieuwe Azure-aanbieding (Azure-plan) in CSP.  
...
- [Trainingsmodule op aanvraag over partnertegoed in Azure in CSP modules (eventbuilder.com)](https://commercial_licensing.eventbuilder.com/NewcommerceinCSPforAzuretrainingmodules)
...
Voor indirecte providers is het belangrijk om ervoor te zorgen dat uw wederverkopers zijn voorbereid op deze wijzigingen. We raden u aan om dit proces zo snel mogelijk te starten. We hebben een reeks gereedheidsmateriaal gemaakt om u te helpen bij het voorbereiden en versnellen van de onboarding-activiteiten van uw reseller, samen met toekomstige webinars voor meer informatie over resellers:
...
De preview-versie van de prijslijst van augustus moet de prijsverhoging hebben weerspiegeld die van invloed is op alle zelfstandige producten van EMS E3, EMS E5 en Intune vanaf 1 augustus 2021.
...
#### <a name="open-license-program-retirement"></a>Buitentreding van het licentieprogramma
...
>[!NOTE]
>Er zijn geen plannen voor het wijzigen van de OV- of Open Value-abonnement programma's.
...
- [Microsoft Open License-programmawijzigingen op Microsoft Licensing News:](https://www.microsoft.com/licensing/news/microsoft-open-license-program-changes?rtc=1)meer informatie over de wijzigingen in het Open License-programma en de licentieopties. Zie ook het gerelateerde Open License-programma wijzigt gereedheidsmaterialen op de [Website van Microsoft-partners.](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/)
...
Raadpleeg uw relevante Microsoft Partner-community's voor vragen over Verbinding maken aanbiedingen. Meer informatie vindt u in de nabije toekomst via gereedheidssessies.
...
| Meerdere  | Er zijn meerdere velden die gedeeltelijk in het adres zijn (mogelijk ook gedeeltelijk en gedeeltelijk van straat).  | Meerdere: maximaal 3  |
...
Zie Een abonnement opzeggen of annuleren om te beginnen met het opnieuw aanschaffen Windows [](../create-a-new-subscription.md#suspend-or-cancel-a-subscription)7 ESU Year 2 (2021).
...
Via het CSP-programma kunnen partners de bedrijven van hun klanten digitaal transformeren met toonaangevende cloudoplossingen. Als onderdeel van deze inspanning wordt bestaande SKU's met korting teruggetrokken (zie het tabblad SKU's [](https://partner.microsoft.com/resources/detail/dynamics-365-cloud-promotion-retired-skus-xls)met korting op het tabblad Dynamics 365 Cloudmigratie-promotie en het Excel-bestand voor niet-bestaande SKU's) op 31 juli 2021 en vervang deze door nieuwe Dynamics 365 Cloudmigratie-promotie-SKU's.
...
Zie het tabblad Promotie-SKU's in het Dynamics [](https://partner.microsoft.com/resources/detail/dynamics-365-cloud-promotion-retired-skus-xls)365 Cloudmigratie-promotie- en Excel-bestand ) voor een volledige lijst met de SKU's.
