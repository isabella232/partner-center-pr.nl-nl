...
Meer informatie over de exportfunctie kunt u bekijken in onze handleiding [Insights in Partner Center](../referral-insights.md#export).
...
- Volg ons op 18 augustus voor een [go-to-market webinar](https://aka.ms/Windows365PartnerWebinar) voor partners voor meer informatie over de partnerkans met Windows 365.
...
U wordt aangeraden de API voor activiteitenlogboek te gebruiken voor meer efficiëntie en om beperking te voorkomen. Raadpleeg voor meer informatie over deze functie de informatie in API-beperkingsinformatie voor partners die Partner Center [aanroepen.](/partner-center/develop/api-throttling-guidance)  
...
- Registreer u bij [Open Retirement - Migration to CSP/Open Value: Partner Operations Considerations](https://globalpbocomm.eventbuilder.com/OpenMigrationToCSPOV) for the September 1 and 2 webinars on Partner Center onboarding and an overview for indirect resellers in CSP (Partner Operations Considerations voor de webinars van 1 en 2 september over Partner Center onboarding en een overzicht voor indirecte resellers in CSP).
- Reseller Open License to CSP-overgang aanpasbare materialen om indirecte providers te helpen bij het versnellen van de onboarding van resellers en de acceptatie van doorlopende software in het CSP-programma zijn beschikbaar op Reseller Open License naar CSP-overgangsmaterialen. [](https://partner.microsoft.com/resources/collection/reseller-open-license-to-csp-transition-materials#/)
- Onboarding-webinars over OV-bewerkingen ter ondersteuning van het scenario voor klantovergang van Open License naar OV vinden plaats op 8 en 9 september. Zie de [licentie-richtlijnen](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-licensing-guidence-pdf) voor alle overgangsscenario's en registreer u bij Open Retirement - Migration to CSP/Open Value: Partner Operations Considerations to attend (Open Retirement - Migratie naar [CSP/Open Value: Partner Operations Considerations)](https://globalpbocomm.eventbuilder.com/OpenMigrationToCSPOV) om deel te nemen.
...
Partners die zijn ingeschreven of binnenkort kunnen worden ingeschreven in MCCL CSP, moeten het volgende materiaal controleren en delen met de relevante belanghebbenden binnen hun organisatie:
...
________________
## <a name="readiness-changes-to-the-cloud-solution-provider-csp-customer-address-validation-api-to-go-live-on-july-13-2021"></a><a name="8"></a>Gereedheid: wijzigingen in de validatie-API van Cloud Solution Provider -klantadres (CSP) voor live gaan op 13 juli 2021
...
Als onderdeel van onze toezegging om partners en klanten te helpen bij het uitvoeren van hun bedrijf op basis van [](https://www.microsoft.com/legal/compliance/anticorruption/criteria) vertrouwen, beeert Microsoft op 7 juli het recht om kortingsinformatie van klanten rechtstreeks aan klanten van de [overheid,](../faq-for-us-govt-cloud.yml)overheidsentiteiten en onderwijsklanten bekend te [maken.](../sell-to-education-customers.md) Raadpleeg de inhoud en video's op De contractvereisten en naleving van [Microsoft (18552)](https://partner.microsoft.com/training/assets/collection/microsoft-contract-requirements-and-compliance-18552#/)voor meer informatie over de contractvereisten voor Microsoft-partners, waaronder Klantkorting Pass-Through en Transparantie.
