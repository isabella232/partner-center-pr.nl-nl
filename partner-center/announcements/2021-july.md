...
Meer informatie over de exportmogelijkheid kunt u bekijken in onze handleiding [Insights in Partner Center.](/partner-center/referral-insights#export)
...
Bekijk deze pagina met partnergalerie voor meer informatie over de nieuwe [](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/)commerce-ervaring in CSP voor Azure en het nieuwe Azure-aanbiedingsplan in CSP.
...
In januari hebben we partners op de hoogte gesteld van aanstaande wijzigingen in de beschikbaarheid van de vorige Azure-aanbieding in het CSP-programma. Zie ook [aankondigingen van januari 2021 voor](./2021-january.md#12) de details van de aankondiging van januari.
...
In fase 1 komen alle nieuwe Azure CSP programma's in de nieuwe Azure-aanbieding (Azure-plan). De volgende richtlijnen zijn van toepassing:
...
- **Gestreamd op meerdere apparaten**
...
Windows 365 is vanaf 2 augustus 2021 beschikbaar voor klanten tot [en met windows365.com,](https://windows365.com)de Enterprise Agreement of het Cloud Solution Provider-programma.
...
2. Klanten van het Open License-programma, eerder dan later, overstappen op het CSP-programma voor permanente softwarebehoeften, of naar de OV- of Open Value-abonnementsprogramma's om de inkomstenstromen van klanten met SA-behoeften te beschermen.
...
- Alle on-premises Dynamics-licenties (Dynamics AX, CRM, Government-partner, NAV, abonnementslicentie en andere) met een actief Dynamics Customer Services and Support-plan (bijvoorbeeld uitbreidingsabonnement of voordeelplan) of Software Assurance (SA) en vernieuwen in Dynamics 365 onlineservices.
