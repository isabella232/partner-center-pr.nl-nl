...
- Begeleid uw resellers bij het overgangsproces als u een indirecte provider bent.
...
Wijzigingen in de beschikbaarheid van de vorige Azure-aanbieding in het CSP-programma.
...
- De vorige Azure-aanbieding is niet langer beschikbaar voor nieuwe partners die in het CSP-programma werken.
...
Met de nieuwe commerce-ervaring worden partners voortdurend herkend voor gedifferentieerde services met toegevoegde waarde via het PEC-model. PEC-beloningen partners die zich richten op het verbeteren van het succes van klanten via services met toegevoegde waarde die duurzame winstgevendheid genereren.
...
- [Microsoft Open License-programmawijzigingen kennisgeving op Microsoft Licensing News:](https://www.microsoft.com/licensing/news/microsoft-open-license-program-changes?rtc=1)meer informatie over de wijzigingen in het Open License-programma en de licentieopties. Zie ook het gerelateerde Open License-programma wijzigt het gereedheidsmateriaal op de [microsoft-partnerwebsite.](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/)
