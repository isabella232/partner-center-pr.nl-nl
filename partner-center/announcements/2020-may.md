...
ms.locfileid: "126244802"
---
# <a name="may-2020-announcements"></a>Aankondigingen van mei 2020

Op deze pagina worden de aankondigingen voor Microsoft Partner Center voor mei 2020.
...
## <a name="microsoft-365-a3--unattended-license-offer-for-education-correction"></a><a name="5"></a>Microsoft 365 A3– Aanbieding voor licentie zonder toezicht voor onderwijscorrectie
...
De volgende Microsoft 365 A3– Unattended License offer for Education is per fout opgenomen in de preview-prijslijst die is gepubliceerd op 1 mei 2020. De aanbieding wordt op 1 augustus 2020 verwijderd uit de prijslijst.
...
## <a name="active-customers-can-renew-their-enhancement-plan-ep-through-the-cloud-solution-provider-csp-program-and-receive-online-licenses"></a><a id="4"/></a>Actieve klanten kunnen hun uitbreidingsplan (EP) verlengen via het Cloud Solution Provider-programma (CSP) en onlinelicenties ontvangen
...
Na zorgvuldige overweging van de huidige omgeving en de mogelijke bedrijfsimpact van COVID-19 op onze on-premises Dynamics Price List (DPL) klanten, heeft Microsoft een aanbieding gemaakt waarmee bestaande klanten die actief zijn op hun EP hun EP kunnen verlengen via het CSP-programma en online dynamics 365 Business Central-licenties kunnen ontvangen. Klanten die ervoor kiezen om hun EP te verlengen via de CSP-EP-verlengingsaanbieding, krijgen de volgende voordelen:

- Een prijspunt dat gelijk is aan de EP-verlenging prijsopgave Dual use and downgrade rights to their current on-premises DPL product (Dynamics 365 Business Central, on-premises, Dynamics NAV, Dynamics GP, and Dynamics SL)
- Een optie voor maandelijkse facturering (afhankelijk van goedkeuring van CSP-partner)
...
- **Licentievereiste:** Klanten moeten Dynamics 365 Business Central-licenties (cloud) aanschaffen met een jaarlijks totaal dat groter is dan of gelijk is aan hun EP-verlengingsbedrag.
...
Microsoft voert maandelijkse beoordelingen uit om ervoor te zorgen dat de klant aan de eisen voldoet. Als de klant niet aan het beleid voldoet, wordt er contact opgenomen met de partner om samen met de klant afwijkingen van geschiktheidsvereisten op te lossen.
- **Uitzondering:** Microsoft staat uitzonderingen toe voor klanten die hun EP tussen 1 januari 2020 en 31 mei 2020 hebben gedingeerd om rekening te houden met de uitdagingen waar bedrijven mee te maken krijgen als gevolg van de huidige wereldwijde gezondheidstoestand. Ze kunnen hun EP opnieuw inschrijven via de CSP-EP-verlengingsaanbieding zonder boete, maar moeten de CSP-EP-verlengingsaanbieding op 31 juli 2020 een licentie geven.
...
- **Prijs:** De CSP-EP-verlengingsaanbieding biedt een prijspunt dat 60% lager is dan de standaard commerciële lijstprijs. De prijs van de CSP-EP-verlengingslijst voor dynamics 365 Business Central (online) Premium-gebruiker is bijvoorbeeld $ 40 vergeleken met de catalogusprijs van $ 100 voor de commerciële prijslijst van de standaard-CSP.
- **Licentievereiste:** Klanten moeten Licenties voor Dynamics 365 Business Central (online) aanschaffen met een jaarlijks totaal dat groter is dan of gelijk is aan hun EP-verlengingsbedrag.
Partners moeten ervoor zorgen dat hun klanten het hele jaar blijven voldoen. Klanten die niet actief blijven op CSP, keren terug naar EP en zijn verantwoordelijk voor alle verantwoordelijke kosten.
- **Aanvullende gebruikers:** Klanten die voldoen aan de licentievereiste en extra licenties nodig hebben om al hun benoemde gebruikers te dekken, kunnen aanvullende gebruikers aanvragen. Er worden geen kosten voor licenties verstrekt via Microsoft Online Subscription-programma promotiecodes. Bij het inwisselen van deze codes moeten klanten een creditcard voor identificatiedoeleinden verstrekken, maar er worden geen kosten in rekening gebracht voor de kaart. De aanvraag voor extra gebruikers moet binnen 60 dagen na de eerste aankoop van de CSP-licentie worden gedaan.
...
- Huidige PartnerSource Business Center (PSBC)-partners moeten hun klanten af zien te zien van automatische verlenging om automatische verlenging van het EP-plan van het volgende jaar te voorkomen.
...
1. Koop Dynamics 365 Business Central onlineservices SKU('s).
   ...
   |-------------------|:------|:------|
   |Dynamics 365 Business Central Premium Cloud-invoeg toevoegen vanuit DPL|   80031106-370e-4090-af6c-48d8394c3357|Dynamics 365 Business Central Premium|
   ...
   |Dynamics 365 Business Central Device Cloud-invoeg-on van DPL|   ce497fb2-0764-4761-b07a-081b85a390c9|Dynamics 365 Business Central-apparaat|
...
2. Voor Solution Provider Agreement(SPA)-partners: dien een aanvraag in bij [Operations](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) om het EP toe te voegen aan het account van de klant. Cases voor bewerkingen kunnen worden gemaakt via PSBC. De volgende case-informatie is nodig:
   ...
   - Bevestiging van kopie van CSP-bestelling
   ...
   - Het PSBC-accountnummer van de partnerorganisatie (indien van toepassing) en de partner-id
...
- Degenen die niet volledig zijn gemigreerd naar Dynamics 365 Business Central onlineservices, kunnen, indien in aanmerking komen, ervoor kiezen om de CSP-EP-verlengingsaanbieding met twee extra jaren te verlengen (totaal van drie jaar).
...
Als u een spa-partner bent, kunt u een aanvraag indienen bij [Operations](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) via PSBC. Als u een spa-partner bent (zonder toegang tot PSBC), kunt u een aanvraag indienen bij een van de volgende e-mailadressen, afhankelijk van de locatie van uw klant in het land:
...
Vanaf vandaag, 15 mei 2020, heeft het Operations Center in Noord- en Zuid-Amerika een nieuw adres. Raadpleeg de tabel voor de adreswijziging.
...
Zorg ervoor dat alle systemen, de communicatie en documentatie zijn bijgewerkt met de nieuwe contactgegevens voor 15 mei 2020.
...
Microsoft is bezig met het toevoegen Kaizala Pro mogelijkheden aan Microsoft Teams, waarbij de Microsoft Kaizala service wordt vervangen. U vindt hier informatie over de Kaizala functies die naar Microsoft Teams [gaan.](https://techcommunity.microsoft.com/t5/microsoft-kaizala-blog/update-on-kaizala-features-coming-to-microsoft-teams/ba-p/974525)

Vanaf 1 juli stopt Microsoft de verkoop van de zelfstandige SKU Kaizala Pro nieuwe of vernieuwde klanten.  Bestaande klanten hebben nog steeds toegang tot de service via hun huidige licentie.
...
Hieronder vindt u een lijst met beïnvloede SKU's. Er zijn geen nieuwe verkopen van deze SKU's. Huidige klanten kunnen op de SKU blijven en toegang blijven houden tot de service. In de volgende bedrijfsprocessen worden er geen kosten in rekening gebracht.
...
|Microsoft Kaizala Pro (Office 365-aanbieding) (KAIZALA_STANDARD_EAP)|AAD-28929|Microsoft Kaizala Pro (Office 365-aanbieding)|CSP|
|Microsoft Kaizala Pro (Office 365-aanbieding) (KAIZALA_STANDARD_EAP)|AAD-28928|Microsoft Kaizala Pro (Office 365-aanbieding)|Direct|
...
Deze wijziging wordt op 1 juni Kaizala aangekondigd voor klanten.

In de tussentijd kunt u meer informatie vinden over de Microsoft365- en Office365-aanbiedingen die Kaizala en Teams toegankelijk blijven op deze sites: [Microsoft 365 for Business](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-products?&activetab=tab%3aprimaryr2), Microsoft 365 for [Enterprise](https://www.microsoft.com/microsoft-365/compare-microsoft-365-enterprise-plans), Microsoft 365 [for Education](https://www.microsoft.com/education/buy-license/microsoft365).
