...
- **Prijs:** De CSP-EP-verlengingsaanbieding biedt een prijspunt dat 60% lager is dan de standaard commerciële lijstprijs. De prijs van de CSP-EP-verlengingslijst voor dynamics 365 Business Central (online) Premium-gebruiker is bijvoorbeeld $ 40 vergeleken met de catalogusprijs van $ 100 voor de commerciële prijslijst van de CSP Standard.
...
- Huidige PartnerSource Business Center (PSBC)-partners moeten ervoor kiezen om hun klanten af te zien van automatische verlenging van het EP-plan van het volgende jaar.
...
1. Koop Dynamics 365 Business Central onlineservices SKU('s).
   ...
   |-------------------|:------|:------|
   |Dynamics 365 Business Central Premium Cloud-invoeg-on van DPL|   80031106-370e-4090-af6c-48d8394c3357|Dynamics 365 Business Central Premium|
...
2. Voor Solution Provider Agreement(SPA)-partners: dien een aanvraag in bij [Operations om](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) het EP toe te voegen aan het account van de klant. Cases voor bewerkingen kunnen worden gemaakt via PSBC. De volgende case-informatie is nodig:
...
- Degenen die niet volledig zijn gemigreerd naar Dynamics 365 Business Central onlineservices, kunnen, indien in aanmerking, ervoor kiezen om de CSP-EP-verlenging met twee extra jaren te verlengen (totaal van drie jaar).
...
Zorg ervoor dat u bestaand materiaal bij te werken met het vorige Reno-adres. Omdat dit alleen een adreswijziging is, is het niet nodig om bestaande contracten opnieuw te ondertekenen.
...
Microsoft is bezig met het toevoegen Kaizala Pro mogelijkheden aan Microsoft Teams, waarbij de Microsoft Kaizala vervangen. U vindt informatie op [Update on Kaizala features coming to Microsoft Teams!](https://techcommunity.microsoft.com/t5/microsoft-kaizala-blog/update-on-kaizala-features-coming-to-microsoft-teams/ba-p/974525).
