...
Microsoft 365 A3– Aanbieding voor onderwijs zonder toezicht is opgenomen in de lijst met preview-prijzen die als fout is gepubliceerd.
...
De volgende Microsoft 365 A3 – Aanbieding voor onderwijs zonder toezicht is per fout opgenomen in de lijst met preview-prijzen die is gepubliceerd op 1 mei 2020. De aanbieding wordt op 1 augustus 2020 verwijderd uit de prijslijst.
...
- Een prijspunt dat gelijk is aan de EP-verlengingsopgave Dubbel gebruik en downgrade-rechten voor hun huidige on-premises DPL-product (Dynamics 365 Business Central, on-premises, Dynamics NAV, Dynamics GP en Dynamics SL)
...
- **Duur van aanbieding:** eerste overeenkomst van één jaar en twee optionele verlengingen van één jaar (totaal drie jaar) of een abonnement van één jaar met de optie voor automatische verlenging van één jaar
...
- **Prijs:** De CSP-EP-verlengingsaanbieding biedt een prijspunt dat 60% lager is dan de standaard commerciële lijstprijs. De aanbiedingslijstprijs voor CSP-EP-verlenging voor dynamics 365 Business Central (online) Premium gebruiker is bijvoorbeeld $ 40 vergeleken met de catalogusprijs van $ 100 voor de commerciële prijslijst van de CSP Standard.
...
2. Voor Solution Provider Agreement(SPA)-partners: dien een aanvraag in bij [Operations](https://mbs2.microsoft.com/Support/OperationsIncidents.aspx?Mode=Create&t=1588193289962) om het EP toe te voegen aan het account van de klant. Cases voor bewerkingen kunnen worden gemaakt via PSBC. De volgende case-informatie is nodig:
   ...
   Voor degenen die geen spa-partners zijn (zonder toegang tot PSBC): verzend de aanvraaggegevens naar een van de volgende e-mailadressen op basis van de landlocatie van uw klant:
...
- Degenen die niet volledig zijn gemigreerd naar Dynamics 365 Business Central onlineservices, kunnen, indien in aanmerking, ervoor kiezen om de CSP-EP-verlengingsaanbieding met twee extra jaren te verlengen (totaal van drie jaar).
...
Controleer altijd de Microsoft-portals op de meest recente sjablonen, omdat deze mogelijk zijn bijgewerkt.
...
|Microsoft Kaizala Pro (Office 365 Offer) (KAIZALA_STANDARD_EAP)|AAD-28929|Microsoft Kaizala Pro (Office 365-aanbieding)|CSP|
|Microsoft Kaizala Pro (Office 365 Offer) (KAIZALA_STANDARD_EAP)|AAD-28928|Microsoft Kaizala Pro (Office 365-aanbieding)|Direct|
...
Ga naar de landingspagina [voor meer informatie over RPA.](https://flow.microsoft.com/ui-flows/) Bekijk [dynamics CSP Offer Updates –May 2020 (Updates dynamics CSP-aanbieding tot mei 2020)](https://partner.microsoft.com/resources/detail/dynamics365-csp-may-2020-offers-xlsx) voor nieuwe SKU-informatie. Ga naar [het partnerprogramma Wijzigingen in geautoriseerde onderwijs in CSP](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/) voor meer informatie over de wijzigingen in het Partnerprogramma voor geautoriseerde onderwijs in CSP.
