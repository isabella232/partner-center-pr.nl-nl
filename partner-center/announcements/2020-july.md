...
#### <a name="extended-dial-out-to-united-states-and-canada-delayed-for-csp-and-web-direct"></a>Uitgebreide inbel-out naar Verenigde Staten canada vertraagd voor CSP en Web Direct
...
Directe factuurpartners en indirecte providers die deelnemen aan het CSP-programma die de api's van Partner Center gebruiken. 
...
**TopProduct:** dit eindpunt is gemaakt als een proof-of-concept dat nooit bedoeld is voor algemene beschikbaarheid. Het is ontworpen om partners in staat te stellen de belangrijkste aanbiedingen te beheren die in de catalogus Partner Center weergegeven. Deze API is echter nooit volledig ontwikkeld en voltooid en wordt uitgeschakeld voor 31 juli 2020. Partners moeten alle verwijzingen naar de gegevens verwijderen.
...
**Hoogtepunten**
- Geen verdere releases van Microsoft voor .NET Framework versie 4.8, omdat dit de laatste versie in de regel is.
...
Microsoft is bezig met het toevoegen van Kaizala Pro mogelijkheden en enkele van de meest gebruikte functies in Microsoft Teams, Microsoft 365 hub voor teamwork.
...
Kaizala en Teams blijven toegankelijk als onderdeel van de volgende SKU'Microsoft 365 en Office 365:
...
[Microsoft 365 voor Enterprise,](https://www.microsoft.com/microsoft-365/compare-microsoft-365-enterprise-plans)met inbegrip van: 
- Office 365 E1
...
Voor meer informatie over de Microsoft 365 en Office 365-aanbiedingen waar klanten nog steeds toegang hebben tot Kaizala en Teams, gaat u naar de volgende websites:
