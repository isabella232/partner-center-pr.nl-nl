...
Op 4 mei 2020 (12:01 uur UTC) introduceert Microsoft nieuwe promoties voor Office 365 E1 en Microsoft 365 Business Basic, ter vervanging van de huidige proefversie van Office 365 E1 voor nieuwe klanten.
...
Deze promoties vervangen de huidige proefversie van Office 365 E1 en verschillen op de volgende manieren:
...
- Bestellen wordt technisch beperkt tot 'alleen nieuwe klanten', in plaats van de proefversie van Office 365 E1, die alleen via geschreven beleid is beperkt tot nieuwe klanten. 
...
Klanten die momenteel een licentie hebben voor de proefversie van Office 365 E1 (beschikbaar tot 4 mei 2020), blijven op hun huidige abonnement. Deze wijziging heeft alleen gevolgen voor nieuwe netklanten.
...
Raadpleeg uw relevante Yammer-community's voor meer vragen over deze aanbiedingen en neem contact op met uw vertegenwoordiger in het Microsoft-account team.
...
## <a name="microsoft-reversed-the-csp-eur-price-for-microsoft-365-e3"></a><a id="12"/></a>Microsoft heeft de CSP EUR-prijs voor Microsoft 365 E3 omgedraaid.
...
Alle partners die M365 E3 via de eur-prijslijst in het Cloud Solution Provider vereenigde.

### <a name="details"></a>Details

Eerder in 2020 hebben we een fout ontdekt in de EUR-prijzen voor Microsoft 365 E3 in CSP: de nettoprijs was lager dan had moeten zijn. We hebben een systeemupdate gepland om de prijs te corrigeren, samen met het prijspunt voor de aanbieding op 1 april 2020.

Hoewel de prijzen fout zijn, is het op dit moment niet geschikt om de correctie en verhoging van de prijzen aan te brengen, gezien de uitzonderlijke omstandigheden. Daarom keren we tijdelijk terug naar onze vorige, lagere nettoprijzen, met ingang van 22 april 2020. Alle facturen weerspiegelen onmiddellijk de vorige lagere prijzen, terwijl in de prijslijst de lagere prijzen uit de prijslijst van mei 2020 voorlopig worden weergegeven.
...
### <a name="target-partner-audiences"></a>Doelgroepen van de doelpartner
...
- **Als** u de aanbevolen beveiligingsvereisten voor het beveiligen van uw tenant en gebruikers niet hebt geactiveerd, moet u dit onmiddellijk doen om compatibel te blijven en bedrijfsonderbrekingen te voorkomen bij het beheren van klanten of transacting in CSP. Partners die de beveiligingsvereisten niet implementeren, kunnen hun deelname aan het CSP-programma in gevaar brengen.
- Indirecte providers moeten deze beveiligingsvereisten implementeren voor hun eigen bedrijf en samenwerken met resellers om ervoor te zorgen dat ze de vereisten implementeren en deze e-mailsjabloon gebruiken. We nemen ook rechtstreeks contact op met uw wederverkopers via e-mailcommunicatie.
...
- Bladwijzer maken voor [Partner Center communitygroep beveiligingsadvies.](https://aka.ms/MPCSecurityGuidance)
...
- USA (Engels) - Wijziging van HipAA Business Associate voor Microsoft Online Services
...
U kunt zich ook aanmelden bij het partnercentrum en naar deze [URL gaan.](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?stage=2&topicid=0570a74b-e021-7aa6-9a81-d0fe505b8df5)
...
Eigenaren van MDATP voor Servers-SKU's moeten upgraden naar Azure Security Center (ASC) Standard met de SKU met $ 10-stapsup om te profiteren van asc Standard-functies.
...
- Lees de [Azure Security Center documentatie voor](/azure/security-center/) meer informatie over Azure Security Center.
...
Microsoft start commerciële M365 - Onbeheerde licentieaanbiedingen op 1 mei 2020 opnieuw om de beste partner- en klantervaring te garanderen. Dit heeft geen invloed op de prijs en mogelijkheden.
...
Microsoft was van plan commerciële M365 - Onbeheerde licentieaanbiedingen te starten op 1 april 2020, volgens de preview-prijslijst. Na uitgebreide tests hebben we geleerd dat gebruikers onverwacht gedrag kunnen ondervinden tijdens het inrichten.

Daarom wordt het project op 1 mei 2020 opnieuw gelanceerd. De herstart heeft geen invloed op de prijzen of de waarde die is opgenomen in de aanbieding.
We zijn ook actief van plan om deze aanbieding op mei 2020 uit te breiden naar klanten uit het onderwijs en de overheid, zodat u uw bedrijf kunt uitbreiden en nieuwe mogelijkheden kunt vinden om fantastische waardeaanbiedingen te blijven leveren.
...
Microsoft 365 E3-licentie zonder toezicht maakt het gebruik van Office-toepassingen met serviceaccounts of andere niet-gebruikersaccounts mogelijk, zoals gebruikelijk is tijdens het automatiseren van het proces.
...
Deel deze informatie met alle juiste contactpersonen in uw organisatie en controleer uw aankondigingen [op](https://partner.microsoft.com) partner.microsoft.com op toekomstige updates.

### <a name="questions"></a>Vragen?

Voor meer vragen over deze aanbiedingen kunt u contact opnemen met uw vertegenwoordiger in het Microsoft-account of uw relevante Yammer-community's controleren.
...
### <a name="microsoft-365-a5-compliance-mini-suites"></a>Microsoft 365 A5 Compliance mini suites

Vanaf 1 april 2020 kunnen Microsoft-partners ook de volgende minisuites aanbieden. Deze invoegaanbiedingen bieden specifieke subsets van de Microsoft 365 A5-nalevingswaarde, wat extra klantgroeimogelijkheden biedt voor specifieke use cases en klantbehoeften.
...
Naast de bovenstaande wijzigingen stelt Microsoft Office 365 Advanced Compliance and Azure Information Protection (AIP) Plan 2 in. Vanaf 1 april 2020 zijn deze aanbiedingen niet meer beschikbaar in de prijslijst voor net nieuwe klanten en is automatisch verlengen uitgeschakeld voor bestaande klanten.
...
## <a name="office-365-e1-trial-now-available-to-csp-partners"></a><a id="5"/></a>Proefversie van Office 365 E1 nu beschikbaar voor CSP-partners
...
Vanaf 1 april 2020 is er een nieuwe proefversie van Office 365 E1 beschikbaar voor aankoop in CSP. De aanbieding is beschikbaar gesteld op de prijslijst om de recente toename in extern werken aan te pakken.
...
Mensen en teams over de hele wereld werken op afstand. Partners passen zich snel aan om hun klanten te ondersteunen en wij passen ons aan.

Met trots kondigen we een nieuwe proefversie van Office 365 E1 aan in CSP, die speciaal is gemaakt ter ondersteuning van de reactie van partners op de groeiende behoeften voor extern en slim werken. Deze proefversie is tot nader order beschikbaar vanaf 1 april 2020.

De proefversie van CSP Office 365 E1 is nu beschikbaar naast de huidige Microsoft Teams CSP-proefversie (die geen Exchange en 2 GB aan opslagruimte heeft). De nieuwe proefversie heeft vergelijkbare functionaliteit als de proefversie van Office 365 E1 en biedt zes maanden gratis gebruik voor maximaal 3000 gebruikers. Deze aanbieding is beschikbaar via CSP en biedt partners de mogelijkheid om de proefversie te initiëren en te beheren.

### <a name="offer-id"></a>Aanbiedings-id

- Weergavenaam: Proefversie van Office 365 E1
...
- [Bekijk de veelgestelde vragen over de proefversie van CSP Office 365 E1](https://aka.ms/CSPE1OfferFAQ)
- [Meer informatie over proefversies en aanbiedingen van Microsoft Teams](https://www.microsoft.com/microsoft-365/partners/resources/teams-offers-and-trials-comparison)
...
Als u vragen hebt over deze aanbiedingen, controleert u uw relevante Yammer-community's. Voor andere problemen kunt u een ticket indienen via Partner Center Ondersteuning.
...
Bekijk hier de specifieke wijzigingen in het dynamics CSP-aanbiedingsbestand Updates-Mar 2020. [](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)

### <a name="robotic-process-automation"></a>Automatisering van geautomatiseerde processen

Op 1 mei 2020 breidt Microsoft de beschikbaarheid van nieuwe RPA-aanbiedingen uit in de Education-programma's.
...
Met ingang van 1 april 2020 hebben eCommerce-aanbiedingen weergavenaam- en/of PFAM-wijzigingen in de uiteindelijke prijzen werkbladen. De wijzigingen worden beschreven in de onderstaande tabel.

|**Weergavenaam en/of PFAM-wijziging**|**1 maart 2020**|**1 april 2020**|
|-------------------|:------|:-----|
|Weergavenaam|eCommerce-beoordelingen en beoordelingen|CommerceBeoordelingen en beoordelingen|
|Weergavenaam|Aanbevelingen voor eCommerce|Aanbevelingen voor commerce|
|Weergeven en PFAM|Dynamics 365 Commerce Cloud Scale Unit Basic|Dynamics 365 Commerce Scale Unit Basic - Cloud|
|Weergeven en PFAM|Dynamics 365 Commerce Cloud Scale Unit Standard|Dynamics 365 Commerce Scale Unit Basic - Cloud|
|Weergeven en PFAM|Dynamics 365 Commerce Cloud Scale Unit Premium|Dynamics 365 Commerce Scale Unit Premium - Cloud|
...
Neem contact op met de ondersteuning voor hulp die uitsluitend betrekking heeft op uw activiteiten [met Microsoft.](https://partner.microsoft.com/pcv/servicerequests/create)
...
**Uw feedback is belangrijk voor ons!** Wanneer u de nieuwe locatie Operations Readiness gebruikt, nodigen we u uit om feedback te geven, zodat we uw ervaring kunnen blijven verbeteren. U kunt dit doen met behulp van de **pagina Was deze pagina nuttig? Ja | Er** is geen feedbackprogramma beschikbaar onder aan elke pagina.

Microsoft streamlint de manier waarop we communiceren en gereedheidsmaterialen bieden voor alle Microsoft-programma's. We introduceren één resourcelocatie voor Operations-gereedheid op de website van de Microsoft-partner op die assets uit de [https://partner.microsoft.com](https://partner.microsoft.com) [resourcegalerie voor CSP-programma-updates](https://partner.microsoft.com/resources#/) en de [Microsoft Readiness-site combineert.](https://www.microsoftreadiness.com/)
...
### <a name="expanding-on-the-success-of-the-csp-program-updates-resource-gallery"></a>Uitbreidend op het succes van de resourcegalerie van CSP-programma-updates:
...
- **Uitgebreede inhoud:** Alle recente en relevante inhoud van de Microsoft-gereedheidssite en de resourcegalerie voor updates van het CSP-programma worden verplaatst naar de nieuwe locatie voor gereedheid voor bewerkingen, wat betekent dat inhoud voor meer programma's nu op één locatie wordt opgeslagen.
...
- **Neem deel aan een oproep van de partner-community** van april waar u meer informatie kunt vinden over de nieuwe ervaring en vragen kunt stellen: [https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)
...
- 23 maart 2020: De overgang van de resourcegalerie van het CSP-programma wordt bijgewerkt naar de resourcelocatie Operations Readiness, bijgewerkt naar 3 april 2020
- 9 maart 2020: Kennisgeving van 30 dagen, bijgewerkt gereedheidsmateriaal
...
- Alle CSP-partners die in deze [landen werken.](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)
- Partners in Australië moeten onze onderstaande richtlijnen controleren.

### <a name="details"></a>Details

Op 1 april 2020 introduceert Microsoft Microsoft 365 Business Voice in aanvullende geografische gebieden. Er zijn twee aanbiedingen beschikbaar: Microsoft 365 Business Voice en Microsoft 365 Business Voice Without Calling Plan (met behulp van directe routering). Beide aanbiedingen zijn beschikbaar in de Verenigde Staten

### <a name="customer-value-proposition"></a>Waardepropositie van de klant

Microsoft 365 Business Voice is een cloudtelefoonsysteem voor bedrijven van maximaal 300 gebruikers. Het biedt de mogelijkheid om vanuit elk telefoonnummer in Microsoft Teams te bellen en te ontvangen. Samen met Teams biedt het een alles-in-een-communicatieoplossing waarin oproepen, chat en vergaderingen worden gecombineerd.

Microsoft 365 Business Voice vereenvoudigt en stroomlijnt de productiviteit en communicatie in één toepassing die overal werkt waar bedrijven dat doen: op computers, smartphones en bureautelefoons. De voordelen van Microsoft 365 Business Voice zijn:

- Alles-in-één-communicatie. Transformeer hoe werk wordt uitgevoerd door oproepen, chat, vergaderingen, agenda en e-mail samen te roepen.
...
Microsoft 365 Business Voice is beschikbaar als een invoeg-on voor de volgende abonnementen:
...
- Het telefoonsysteem inschakelen met oproepwachtrijen/automatisch afleiden, de netwerkkwaliteit beoordelen of directe routering en audiovergaderingen configureren.
...
**Microsoft 365 Business Voice without Calling Plan (meer dan 70 landen)**

U kunt ook vanaf 1 april 2020 de aanbieding Business Voice Without Calling Plan kopen, die telefoonsysteem- en audiovergaderingen bevat. Deze aanbieding is beschikbaar in alle landen die hier worden vermeld.

- **Verenigde Staten alleen:** Microsoft 365 Business Voice Without Calling Plan: 39d7d0f-eb8f-4ebc-b618-692e1cc59c8f
- **De rest van de wereld:** Microsoft 365 Business Voice Without Calling Plan: cc69a07c-8c51-457f-bb2a-f21a62d6bede
...
Partners in Australië moeten er rekening mee houden dat de aanbieding Microsoft 365 Business Voice Without Calling Plan niet beschikbaar is in de productieprijslijst op 1 april 2020, ondanks dat deze beschikbaar is in de preview-prijslijst in maart 2020. Bedankt voor uw begrip.

### <a name="further-countries"></a>Meer landen

Na een periode hopen we Microsoft 365 Business Voice te kunnen gebruiken in alle landen waar Office 365 en Microsoft 365 beschikbaar zijn.

### <a name="next-steps"></a>Volgende stappen

- Raadpleeg onze partnergalerie voor meer informatie over de toegevoegde waarde van deze aanbieding, en om uw Microsoft Teams-praktijk op te stellen en te consolideren: Microsoft 365 [Business Voice-beschikbaarheid in CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)
...
- Indirecte resellers die de Microsoft Partner-overeenkomst niet meer in aanmerking komen om te fungeren als partner van records voor nieuwe orders.

**Als u dit nog niet hebt gedaan, moet u de volgende acties onmiddellijk uitvoeren.**

### <a name="actions-for-direct-bill-partners"></a>Acties voor partners met directe factuur:
...
Meer informatie en resources zijn beschikbaar via de pagina CSP Gallery [hier](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).

### <a name="actions-for-indirect-providers"></a>Acties voor indirecte providers
1. Informeer de belangrijkste belanghebbenden in uw organisatie om de Microsoft Partner-overeenkomst.
2. Ga akkoord met de Microsoft Partner-overeenkomst op de [CSP-overzichtspagina van het Partnercentrum](https://partner.microsoft.com/pcv/dashboard/overview) met referenties van een globale beheerder.
3. Gebruik de [API om de ondertekeningsstatus van](/partner-center/develop/verify-indirect-reseller-mpa-status)uw indirecte reseller te controleren.
4. Help uw indirecte resellers met het voltooien van de onderstaande acties.

Meer informatie en resources zijn beschikbaar via de pagina CSP Gallery [hier](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).

We zijn op de hoogte van technische problemen die indirecte providers ondervinden bij het testen van de transactionele afdwingingsmogelijkheden. Deze problemen worden in april 2020 opgelost.

### <a name="actions-for-indirect-resellers"></a>Acties voor indirecte resellers
1. [Onboard naar Partner Center](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/) als indirecte reseller en accepteer de Microsoft Partner-overeenkomst als onderdeel van het onboardingproces.
...
- 24 januari 2020: Webinar Series invites updated for w/c 27 January 2020 .
