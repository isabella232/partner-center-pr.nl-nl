...
Klanten die momenteel een licentie hebben voor Office 365 E1 proefversie (beschikbaar tot 4 mei 2020), blijven op hun huidige abonnement. Deze wijziging heeft alleen gevolgen voor net nieuwe klanten.
...
## <a name="microsoft-reversed-the-csp-eur-price-for-microsoft-365-e3"></a><a id="12"/></a>Microsoft heeft de CSP EUR-prijs voor Microsoft 365 E3.
...
- Bekijk de handleiding [Statuscontrole van beveiligingsvereiste.](../partner-security-compliance.md)
...
- Bladwijzer voor [de Partner Center communitygroep Beveiligingsadviezen.](https://aka.ms/MPCSecurityGuidance)
...
- WW (Engels) - Wijziging in financiële dienstverlening
...
- Stap 3: selecteer deze, klik op Oplossingen controleren
...
Eigenaren van MDATP voor Servers-SKU's moeten upgraden naar Azure Security Center (ASC) Standard met de SKU met $10-staps om te profiteren van ASC Standard-functies.
...
Als u vragen hebt met betrekking tot uw activiteiten met Microsoft, [neem dan contact op met de ondersteuning via uw Partnerdashboard.](https://partner.microsoft.com/pcv/servicerequests/create)

### <a name="change-log"></a>Wijzigingenlogboek

- Oorspronkelijke publicatiedatum van 23 maart 2020: Communicatie vóór de lancering
- Update van 17 april 2020: Reflect Now Available

_________________

## <a name="americas-operations-center-address-change"></a><a id="8"/></a>Adreswijziging in Operations Center in Noord-Amerika
...
Het adres voor het Microsoft Americas Operations Center in Reno verandert en voor alle systemen, communicatie en documentatie is een update vereist.
...
**Uw feedback is belangrijk voor ons!** Wanneer u de nieuwe locatie Voor gereedheid voor bewerkingen gebruikt, nodigen we u uit feedback te geven, zodat we uw ervaring kunnen blijven verbeteren. U kunt dit doen met behulp van de **pagina Was deze pagina nuttig? Ja | Er** is geen feedbackprogramma beschikbaar onder aan elke pagina.
...
Microsoft 365 Business Voice is beschikbaar als een invoeg-on voor de volgende plannen:
...
Vanaf april 2020:
- Directe factuurpartners en indirecte providers die de Microsoft Partner-overeenkomst niet hebben geaccepteerd, kunnen geen nieuwe orders plaatsen en zijn beperkt tot het beheren van alleen bestaande abonnementen.
...
- 24 januari 2020: Webinar Series invites updated for w/c 27 January 2020 (Uitnodigingen voor webinarserie bijgewerkt voor w/c 27 januari 2020).
