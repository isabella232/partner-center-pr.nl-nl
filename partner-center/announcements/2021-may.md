...
Fase 2 van de Europese Unie (EU)/EfTA (Europese Free Trade Association) en de wijziging van partnerfactureringsvaluta voor nieuwe handelsaanbiedingen in het Verenigd Koninkrijk (VK) is binnenkort beschikbaar.
...
- Partners die Partner Center of de gebruikersinterface (UI) van de Azure.com-portal gebruiken, moeten zich na fase 2 voorbereiden op wijziging in valuta.
...
- Partners merken een verminderde factureringscomplexiteit op die wordt veroorzaakt door facturering met meerderecurrencys, waardoor er tijd en resources worden vrij gemaakt die zijn gekoppeld aan het afstemmen van accounts.
...
________________
## <a name="deprecation-of-microsoft-365-business-voice-getting-started-wizard-gsw"></a><a name="11"></a>Afschaffing van Microsoft 365 Wizard Business Voice Aan de slag (GSW)
...
De Microsoft 365 Business Voice Aan de slag Wizard (GSW) wordt op 1 juni 2021 uit bedrijf genomen en wordt vervangen door een verbeterde Teams Admin Center-ervaring en nieuwe installatiedocumentatie.
...
Vanaf 1 juni 2021 wordt de wizard Microsoft 365 Business Voice Aan de slag (GSW) uit bedrijf genomen en vervangen door een verbeterde ervaring van het Teams-beheercentrum en nieuwe, uitgebreide documentatie om de eerste configuratie van Business Voice mogelijk te maken. Dit omvat stapsgewijse instructies voor het verkrijgen van telefoonnummers, toewijzing van licenties en telefoonnummers, wachtrijen voor bellen en automatisch instellen van telefoonnummers.

### <a name="faqs"></a>Veelgestelde vragen

#### <a name="who-is-impacted-by-this-change"></a>Wie wordt beïnvloed door deze wijziging?

Alleen nieuwe Business Voice-klanten. Vanaf 1 juni 2021 worden alle nieuwe klanten omgeleid naar de nieuwe documentatie. Van 1 tot en met 30 juni 2021 is de GSW nog steeds beschikbaar voor bestaande klanten, zodat klanten 30 dagen de tijd hebben om de wizard te voltooien voordat deze niet meer beschikbaar is voor hen.
...
Nee. Dit is alleen van invloed op de functie Aan de slag wizard. Microsoft blijft investeren in de functionaliteit Microsoft 365 business voice en functies waarmee klanten en partners beter kunnen communiceren en samenwerken.
...
________________
## <a name="may-cloud-solution-provider-csp-community-update-and-reminders"></a><a name="10"></a>Updates en Cloud Solution Provider van de CSP-community (May Cloud Solution Provider)
...
- [Testmogelijkheid nu beschikbaar: wijzigingen in de api voor Cloud Solution Provider van klantadressen die in juni live gaan](https://partner.microsoft.com/resources/detail/testing-capability-for-csp-customer-address-validation-api-now-available-pdf)
...
- De downloadbare [maandelijkse CSP-nieuwsbrieven](https://partner.microsoft.com/resources/detail/csp-monthly-update-may-2021-global) voor het bijwerken van recente CSP-aankondigingen, updates, gebeurtenissen en herinneringen in een eenvoudig te lezen document.
...
- De nieuwe [gereedheidshandleiding voor](https://partner.microsoft.com/resources/collection/global-promo-readiness-guide-collection#/) globale promo's, waarin recente en toekomstige promoties worden verzameld die beschikbaar zijn voor partners en klanten.
...
Zie De kwalificatie van een klant asynchroon krijgen voor [een API-voorbeeld.](/partner-center/develop/get-customer-qualification-asynchronous.md)
