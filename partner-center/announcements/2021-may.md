...
#### <a name="reminder-changes-to-the-csp-return-period-and-software-download-link-expiry-dates"></a>Herinnering: Wijzigingen in de CSP-retourperiode en vervaldatums van de software downloadkoppeling

Noteer de volgende wijzigingen voor permanente aankopen van software- en softwareabonnementen via Partner Center:

- **1 juni 2021:** De retourperiode voor softwareaanbiedingen in CSP, zoals vermeld in de Microsoft Partner-overeenkomst, wordt gewijzigd van 60 dagen van orderdatum in 30 dagen na orderdatum.
...
- Partners die Gebruikmaken van Microsoft-API's of een externe leverancier van het configuratiescherm (CPV) voor elke vorm van factureringsautomatisering, moeten de benodigde wijzigingen aanbrengen om de wijziging van valuta voor hun klant mogelijk te maken.
...
Cloud Solution Provider (CSP)-partners in de VS, het VERENIGD Koninkrijk en Canada die Microsoft 365 Business Voice met een oproepplan
...
Nee. Dit is alleen van invloed op de functie Aan de slag wizard. Microsoft blijft investeren in Microsoft 365 Business Voice functionaliteit en functies waarmee klanten en partners beter kunnen communiceren en samenwerken.

### <a name="next-steps"></a>Volgende stappen

Als u een partner in de VS, het VK [of](/microsoftteams/business-voice/)Canada bent en Business Voice met een oproepplan verkoopt, wordt u aangeraden vertrouwd te raken met de nieuwe stapsgewijs documentatie (die beschikbaar is in de [Microsoft 365 Business Voice-documentatiehub),](/microsoftteams/business-voice/set-up-overview) zodat u klanten kunt ondersteunen die mogelijk hulp nodig hebben bij het instellen van Business Voice.
...
- [Testmogelijkheid nu beschikbaar: wijzigingen in de validatie-API Cloud Solution Provider van klantadressen die in juni live gaan](https://partner.microsoft.com/resources/detail/testing-capability-for-csp-customer-address-validation-api-now-available-pdf)
...
________________
## <a name="default-bank-profile-functionality-is-available-in-partner-center-for-incentive-enrollment"></a><a name="8"></a>De standaardfunctie voor bankprofiel is beschikbaar in Partner Center voor incentive-inschrijving
