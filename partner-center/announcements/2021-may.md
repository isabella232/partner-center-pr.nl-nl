...
________________
## <a name="sandbox-support-for-indirect-model-to-enable-end-to-end-api-testing"></a><a name="15"></a>Sandbox-ondersteuning voor indirect model om end-to-end-API-testen mogelijk te maken
...
2. Selecteer **Instellingen** en selecteer vervolgens **Accountinstellingen.**
...
________________
## <a name="june-online-services-ols-and-software-channel-authorization-guide"></a><a name="14"></a>Ols (Online Services) en softwarekanaalautorisatiehandleiding van juni
...
Directe factuurpartners, indirecte providers en partners met meerderelaags die deelnemen aan het Cloud Solution Provider (CSP)-programma

### <a name="details"></a>Details

In overeenstemming met de Microsoft Partner-overeenkomst (in de sectie OLS-software en kanaalautorisatie/kennisgeving van wijzigingen/wijzigingen in de handleidingen), meldt Microsoft u dat de ols- en softwarekanaalautorisatiehandleiding wordt bijgewerkt. Hier is een voorbeeld van de [bijgewerkte](https://partner.microsoft.com/resources/detail/update-guide-online-services-software-channel-authorization-june-pdf)handleiding beschikbaar, met een rode lijn die de hier [beschikbare wijzigingen demonstreert.](https://partner.microsoft.com/resources/detail/update-guide-online-services-software-channel-authorization-june-redline-pdf) Deze update wordt 30 dagen na de datum van deze kennisgeving van kracht. U hoeft verder niets te doen.
...
________________
## <a name="updates-on-transacting-perpetual-software-in-csp-and-changes-to-the-open-license-program"></a><a name="13"></a>Updates voor het transacteren van permanente software in CSP en wijzigingen in het Open License-programma
...
________________
## <a name="phase-2-coming-soon-euefta-and-uk-change-of-partner-billing-currency-for-new-commerce-offers"></a><a name="12"></a>Fase 2 binnenkort beschikbaar: EU/EFTA en UK wijzigen van partnerfactureringsvaluta voor nieuwe commerceaanbiedingen
...
________________
## <a name="deprecation-of-microsoft-365-business-voice-getting-started-wizard-gsw"></a><a name="11"></a>Afschaffing van Microsoft 365 Business Voice Aan de slag Wizard (GSW)
...
De Microsoft 365 Business Voice Aan de slag Wizard (GSW) wordt op 1 juni 2021 uit bedrijf genomen en wordt vervangen door een verbeterde teams-beheercentrumervaring en nieuwe installatiedocumentatie.

### <a name="impacted-audience"></a>Beïnvloede doelgroep

Cloud Solution Provider (CSP)-partners in de VS, het VERENIGD Koninkrijk en Canada die Microsoft 365 Business Voice met een oproepplan verkopen
...
In de afgelopen maanden zijn we blijven investeren in nieuwe spraakfuncties waarmee klanten beter kunnen communiceren en samenwerken, zoals een vereenvoudigde oproepervaring, samenwerking met oproepen en kanalen met spraakfuncties.

Vanaf 1 juni 2021 wordt de wizard Microsoft 365 Business Voice Aan de slag (GSW) ingetrokken en vervangen door een verbeterde ervaring van het Teams-beheercentrum en nieuwe, diepgaande documentatie om de eerste configuratie van Business Voice mogelijk te maken. Dit omvat stapsgewijse instructies voor het verkrijgen van telefoonnummers, het aanvragen van licenties en telefoonnummers, het instellen van wachtrijen voor bellen en het automatisch instellen van een telefoonnummer.
...
Nee. Dit is alleen van invloed op de Aan de slag wizardfunctie. Microsoft blijft investeren in de functionaliteit Microsoft 365 business voice en functies waarmee klanten en partners beter kunnen communiceren en samenwerken.
...
- [Microsoft 365 Business Voice-documentatiehub](/microsoftteams/business-voice/)
...
________________
## <a name="may-cloud-solution-provider-csp-community-update-and-reminders"></a><a name="10"></a>Updates Cloud Solution Provider de CSP-community (mei) en herinneringen
...
- [Testmogelijkheid nu beschikbaar: Wijzigingen in de api voor Cloud Solution Provider-adresvalidatie van klanten gaan in juni live](https://partner.microsoft.com/resources/detail/testing-capability-for-csp-customer-address-validation-api-now-available-pdf)
...
________________
## <a name="default-bank-profile-functionality-is-available-in-partner-center-for-incentive-enrollment"></a><a name="7"></a>Standaardfunctionaliteit voor bankprofiel is beschikbaar in Partner Center voor incentive-inschrijving
