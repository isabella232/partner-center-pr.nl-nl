...
> [!IMPORTANT]
> Lees alle instructies zorgvuldig en controleer de indeling van elke kolom uit de onderstaande tabel voordat u deals maakt of bij te werken met csv-bestanden in Partner Center.

Niet elk veld in de sjabloon kan worden bewerkt. Er zijn velden die altijd alleen-lezen zijn, sommige worden gewijzigd in de status Alleen-lezen na het maken van een verwijzing, en sommige worden gewijzigd in alleen-lezen nadat u ze hebt gewijzigd in een specifieke waarde.
...
### <a name="fields-that-will-become-read-only-after-you-create-the-referral"></a>Velden die alleen-lezen worden nadat u de verwijzing hebt maken
...
- Toestemming om de contactpersoon van de klant/partner te delen
- MPN-id
...
- **De voornaam van de contactpersoon** van de klant wordt alleen-lezen na het verzenden van de gegevens voor het maken of upgraden van een verwijzing voor co-verkoop
- **De achternaam van de contactpersoon** van de klant wordt alleen-lezen nadat u de gegevens hebt verzenden voor het maken of upgraden van een verwijzing voor co-verkoop
- **Klantcontactcontact Telefoon wordt alleen-lezen** na het verzenden van de gegevens voor het maken of upgraden van een verwijzing voor co-verkoop
- **Het e-mailadres van de** contactpersoon van de klant wordt alleen-lezen nadat u de gegevens hebt verzonden voor het maken of upgraden van een verwijzing voor co-verkoop
- **Microsoft Help vereist?** wordt alleen-lezen gebruikt nadat u deze als Ja hebt markeren
- **Welke specifieke hulp van Microsoft?** wordt alleen-lezen gebruikt nadat u een getal in de opgegeven indeling hebt opgegeven
- **Delen met microsoft-verkoopteam** wordt alleen-lezen nadat u deze als Ja hebt markeren
- **Notities voor Microsoft worden** alleen-lezen nadat u de notities voor het maken of upgraden van verwijzingen voor co-verkoop hebt gemaakt

Details van alle kolommen met de details en voorbeeldwaarden vindt u in de onderstaande tabel.
...
D-U-N-S-id van klant|No|Probeer de DUNS-id van de klantorganisatie op te halen. Dit helpt bij een snellere afstemming van de klantorganisatie aan de zijde van Microsoft, waardoor de verkoperstoewijzing sneller kan worden verwerkt. U kunt gratis een DUNS-id krijgen op [de pagina D-U-N-S Number Lookup.](https://www.dnb.com/duns-number/lookup.html)|81466849
...
Substatus van partnerverwijzing|Yes|Geeft de exacte status van de deal aan. Gebruik **Geaccepteerd** als u een nieuwe deal probeert te maken. Dit is ook vereist als u een bestaande verwijzing wijzigt. Waarden die u kunt gebruiken, worden vermeld op [Verwijzingsbronnen.](/partner/develop/referral-resources#referralsubstatus)|Geaccepteerd
...
Verkoopfase|No|Dit is het veld om de gedetailleerde verkoopfase van de verwijzing aan te geven. Lees meer over verkoopfasen in [Verkoopkansen beheren in Partner Center](./manage-co-sell-opportunities.md)|40
