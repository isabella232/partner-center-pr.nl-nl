...
- Met de exportfunctie wordt rekening gehouden met het huidige tabblad op de pagina voor verkoopkansen en de filters die zijn toegepast.
...
Klant-D-U-N-S-id|No|Probeer de DUNS-id van de klantorganisatie op te halen. Dit helpt bij een snellere afstemming van de klantorganisatie aan de zijde van Microsoft, waardoor verkopers sneller kunnen worden toewijsen. U kunt gratis een DUNS-id krijgen van deze [website.](https://www.dnb.com/duns-number/lookup.html)|81466849
...
Verwijzingsstatus van partner|Yes|Geeft de status van de deal aan vanuit het perspectief van uw bedrijf. Vereist als u een verwijzing wilt maken of wijzigen. Gebruik **Nieuw** als u een nieuwe deal wilt maken. Geaccepteerde waarden worden hier [beschreven.](/partner/develop/referral-resources#referralstatus)|Actief
Partnerverwijzingssubstatus|Yes|Geeft de exacte status van de deal aan. Gebruik **Geaccepteerd** als u een nieuwe deal wilt maken. Dit is ook vereist als u een bestaande verwijzing wijzigt. Geaccepteerde waarden worden hier [beschreven.](/partner/develop/referral-resources#referralsubstatus)|Geaccepteerd
...
Toestemming voor het delen van de contactpersoon van de klant/partner|Yes|Toestemming geven voor het delen van contactgegevens van klanten en de contactgegevens van uw werknemers van uw bedrijf die aan de deal werken. **Deals worden niet gemaakt of bijgewerkt als u Nee kiest voor deze kolom.** |Yes
