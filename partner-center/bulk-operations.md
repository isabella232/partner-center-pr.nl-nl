...
|-----|:-----|:---------|:---|
Fouten|No|Er worden fouten weer gegeven als er een fout is opgetreden met betrekking tot de maken/bijwerken-bewerkingen w. r. t met de verwijzingen in deze kolom. Als er meerdere fouten zijn, worden deze weer gegeven gescheiden door een punt komma.|Verplicht veld oplossing 1 ontbreekt|
Betrokkenheid-ID|No|De betrokkenheid-ID wordt gegenereerd door het micro soft Partner Center referrals-systeem. Niet vereist voor het maken van nieuwe verwijzingen. U kunt de bestaande betrokkenheid-ID gebruiken als u een record bijwerkt.|f7eaae47-0b84-4ac4-b4ea-5b2587d42cee
Verwijzings-id|No|Verwijzings-ID wordt gegenereerd door het micro soft Partner Center referrals-systeem. Niet vereist voor het maken van nieuwe verwijzingen. Vul het met de verwijzings-ID in als u een bestaande record bijwerkt.|ebacdkdc-0b84-4ac4-b4ea-5b2587d42cee
Naam van deal|Yes|De beschrijvende naam voor de deal van uw referentie.|Voor jaar van UK
Naam van klant|Yes|De naam van het bedrijf van de klant. Gebruik de juridische naam van de organisatie voor een snelle afstemming aan de kant van micro soft.|Contoso Corporation
Adres regel 1 van klant|Yes|Adres regel 1 van het bedrijf van de klant. |Eén contoso-manier
Adres regel 2 van klant|No|Adres regel 2 van het bedrijf van de klant.|NE 148 straat
...
Referentie status partner|Yes|Geeft de status van de deal van het perspectief van uw bedrijf aan. Vereist als u probeert een verwijzing te maken of te wijzigen. Gebruik **nieuwe** als u probeert een nieuwe deal te maken. Geaccepteerde waarden worden [hier](https://docs.microsoft.com/partner/develop/referral-resources#referralstatus)beschreven.|Actief
Substatus partner referentie|Yes|Hiermee wordt de exacte status van de deal aangegeven. Gebruik **geaccepteerd** als u een nieuwe deal wilt maken. Het is ook vereist als u een bestaande verwijzing wijzigt. Geaccepteerde waarden worden [hier](https://docs.microsoft.com/partner/develop/referral-resources#referralsubstatus)beschreven.|Geaccepteerd
...
Verkoopfase|No|Dit is het veld om de gedetailleerde verkoop fase van de verwijzing aan te geven. Lees [hier](https://aka.ms/salesStages) meer over verkoop stadia|40
Geschatte deal waarde|Yes|"De waarde van de deal op basis van de eerste gesp rekken met de klant. Dit kan worden gewijzigd totdat de deal een van de statussen van de Terminal bereikt| gewonnen of verloren. '|12563
Valuta|Yes|De valuta waarin de deal waarde wordt ingevoerd. U kunt [hier](https://en.wikipedia.org/wiki/ISO_4217)de valuta codes vinden.|USD
Geschatte Sluitings datum|Yes|De geschatte Sluitings datum van de deal op basis van de eerste gesp rekken met de klant in de notatie MM/DD/JJJJ. <br/> **De datum moet in UTC-tijd zone zijn. Alle datums die worden weer gegeven in de gebruikers interface van het partner centrum zijn gebaseerd op gelokaliseerde tijd zones. In de gebruikers interface van het partner centrum is er mogelijk een verschil van +/-dag als u de verwijzing bekijkt waarvoor u de datum in UTC-tijd zone hebt opgegeven.**|1/30/2020
CRM-ID|No|Id van deze specifieke verwijzing in uw CRM-systeem, indien van toepassing. Dit is een invoer veld voor tekst in een vrije vorm.|34234324-sdfsdf-345345-SFD
Marketing campagne-ID|No|Dit veld geeft aan op welke marketing campagne is geresulteerd in deze specifieke verwijzing. Normaal gesp roken gebruikt voor berekening van de ROI|BingSummer2020
Notities|No|Gedetailleerde opmerkingen die de updates met betrekking tot de verwijzing aangeven|Dit is een voor beeld van een opmerking
Is micro soft Help vereist?|Yes|Dit is om aan te geven of u wilt dat micro soft u helpt bij het maken van deze mede koop-aanvraag|Yes
...
Delen met het micro soft-verkoop team|Yes|Dit is om aan te geven of u de details van de deal wilt delen met het micro soft-verkoop team of niet. Dit geldt alleen als u Nee kiest voor de vraag ' micro soft Help vereist? "|Yes
Opmerkingen bij micro soft|No|Eventuele specifieke opmerkingen bij micro soft als u hulp nodig hebt van micro soft|Hulp nodig bij een haalbaarheids test voor contoso-klanten
Toestemming voor het delen van contact persoon van klant/partner|Yes|Toestemming om contact gegevens van klanten te delen en uw werk nemers van uw bedrijf contact opnemen met gegevens die aan de deal werken. **Er worden geen deals gemaakt of bijgewerkt als u Nee kiest voor deze kolom.** |Yes
Oplossing 1|Yes|Oplossings-ID (vereist), de valuta (optioneel) waarin de deal waarde is ingevoerd. U kunt [hier](https://en.wikipedia.org/wiki/ISO_4217)de valuta codes vinden, de prijs van de SKU (optioneel) en de hoeveelheid van de SKU (optioneel)  |SOL-1234-PQRS, USD, 10, 100
Team lid 1|Yes|De voor naam, achternaam, het mobiele nummer en de e-mail-ID van het betrokken teamlid.| Bob, partner, 999999, Bob.partner@Contoso.com
