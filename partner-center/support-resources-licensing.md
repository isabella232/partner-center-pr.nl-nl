...
Als Microsoft-partner bent u mogelijk betrokken bij een of meer licentieprogramma's, kanalen of overeenkomsten. Als u in het Partner Center-dashboard werkt, kan dit programma's bevatten zoals het programma Cloud Solution Provider (CSP) of het programma Microsoft Partner Network (MPN). Andere licentieprogramma's zijn Enterprise Agreement(EA)-licenties, volumelicenties (VL), het OEM-licentieprogramma, het Software Assurance-trainingsprogramma of het programma Voor licentieverlening openen.
...
## <a name="general-resources-about-licensing-and-license-training"></a>Algemene bronnen over licentie- en licentietraining
...
|Functie  | Leest u  |
|:------------------|:--------------- |
|CSP-programmalicenties vergelijken met andere licentiemodellen *(overzicht op hoog niveau)* | Ga naar de [pagina CSP-inschrijving.](https://partner.microsoft.com/licensing/) Schuif omlaag totdat u de sectie CSP vergelijken *met andere licentiemodellen ziet.*  |
...
|Lees meer over het licentieexamen waarmee u Microsoft-licentieoplossingen kunt ontwerpen en leveren aan grote organisaties (examen wordt op *31 januari 2021 om 23:59* uur Centrale tijd ingetrokken)  | [Examen 70-705](/learn/certifications/exams/70-705) |
