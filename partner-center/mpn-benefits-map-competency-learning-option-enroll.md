...
In dit artikel worden de verschillende manieren beschreven waarop een partner in de Microsoft Partner Network kan worden ingeschreven voor het Learning Partner-programma.
...
Dit proces is volledig geautomatiseerd in Partner Center en vereist niet langer een bedrijfstoepassing zoals dit in het Partner Membership Center.
...
Als u op de hoogte wilt blijven van Learning programmaaankondigingen, leest u onze [blog](https://techcommunity.microsoft.com/t5/microsoft-learn/ct-p/MicrosoftLearn) en bekijkt u onze [pagina Learning Partner Yammer bekijken.](https://web.yammer.com/main/groups/eyJfdHlwZSI6Ikdyb3VwIiwiaWQiOiI4NDU0NDI3In0/all) U kunt ook programmadocumenten en maandelijkse community-oproepopnamen vinden op onze [pagina Learning resources.](https://partner.microsoft.com/marketing/learning-resources#/)
...
Als u de silver-optie van een specifieke silver-competentie Learning, bekijkt u de silver-vereisten van die competentie om er zeker van te zijn dat u er aan voldoet. Volg vervolgens deze stappen:

- Voldoe aan de **prestatievereisten die** worden beschreven in Learning Richtlijnen voor programmaprestaties. Deze richtlijnen zijn beschikbaar op [de site Learning Resources.](https://partner.microsoft.com/marketing/learning-resources#/)
...
Voordat u zich kunt inschrijven met de gold Learning-optie, moet u ervoor zorgen dat u voldoet aan de vereisten op gold-niveau Learning competentie.

Het inschrijven bij (of vernieuwen) van een gold competentie-Learning-optie heeft andere vereisten dan inschrijven in de Learning Action Pack- of silver-Learning optie. Als u wilt voldoen aan de vereisten voor een gold-Learning-optie, moet u ook voldoen aan de vereisten op gold-niveau Learning de KPI-vereisten van die competentie. Als u niet aan de KPI's of andere vereisten hebt voldaan, moet u zich inschrijven voor de optie Learning Action Pack of Silver, afhankelijk van het niveau van de vereisten dat is voldaan, als u een Learning Partner wilt worden.
...
Nee. In Partner Center is een Business Application Plan niet vereist om een competentie te verkrijgen via de Learning optie. U moet voldoen aan Learning KPI's van het eerste jaar van de inschrijving.

### <a name="q-if-i-am-a-net-new-partner-and-decide-to-buy-courseware-trainings-or-certifications-before-applying-for-the-learning-option-will-the-kpis-be-recognized-by-partner-center-automatically"></a>V: Als ik net nieuwe partner ben en besluit cursusware, trainingen of certificeringen te kopen voordat ik me voor de Learning-optie ga aanmelden, worden de KPI's dan automatisch herkend door Partner Center?

Ja, de KPI's moeten worden herkend in Partner Center.

### <a name="q-where-should-i-go-in-case-there-is-a-discrepancy-between-kpis-in-partner-center-under-the-learning-option-and-my-kpi-dashboard"></a>V. Waar moet ik naartoe als er een discrepantie is tussen KPI's in Partner Center onder de optie Learning en mijn KPI-dashboard?
...
Mogelijk moet u aan de map [Learning partner toevoegen.](/learn/certifications/partners) U kunt vervolgens een koppeling naar uw website maken via Learning partnermappagina.
