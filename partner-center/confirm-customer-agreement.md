...
**Optie 1:** Attestation van klantacceptatie door partners: de partner kan de acceptatie van de klant bevestigen met behulp van Partner Center API/SDK of via het Partner Center dashboard.

**Optie 2:** directe acceptatie door de klant: de partner kan de klant uitnodigen via een URL om de overeenkomst te controleren en te accepteren in Microsoft 365-beheer Center.
...
Partners met directe factuur kunnen bevestigen dat de klant de Microsoft-klantovereenkomst in Partner Center voor nieuwe en bestaande klanten. Indirecte resellers kunnen niet namens hun klanten bevestigen en moeten samenwerken met hun indirecte provider om de attestation te laten uitvoeren.
...
Gebruik de volgende stappen om een nieuwe klant te maken in Partner Center nodig ze vervolgens uit om de Microsoft-klantovereenkomst in Microsoft 365-beheer Center te controleren en te accepteren.
