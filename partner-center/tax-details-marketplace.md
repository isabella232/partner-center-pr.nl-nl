...
|Bosnia & Herzegovina|Gibraltar|Mauritius|
...
- Scenario 1: Klant in een aanbieding voor aankopen in een door uitgever beheerd land

  :::image type="content" source="images/tax/scenario-one.png" alt-text="Grafiek waarin wordt weergegeven hoe de uitgever betaalt.":::

- Scenario 2: Klant in een door Microsoft beheerde aanbieding voor het kopen van landen (uitgeverland niet relevant)

  :::image type="content" source="images/tax/scenario-two.png" alt-text="Grafiek met belasting in door Microsoft beheerd land":::

- Scenario 3: Een uitgever van een vreemde uitgever maakt een cross-border verkoop aan een klant die is geregistreerd bij BTW in een door Microsoft beheerd land
