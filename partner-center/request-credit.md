...
In dit artikel wordt uitgelegd Cloud Solution Provider directe en indirecte CSP-providers tegoed kunnen aanvragen voor:
...
2. Meld u aan bij [Partner Center dashboard,](https://partner.microsoft.com/dashboard)selecteer het vraagtekenpictogram (?) en selecteer **vervolgens Help en ondersteuning.**
...
2. Selecteer het vraagtekenpictogram (?), vervolgens **Help en ondersteuning** en selecteer vervolgens Nieuwe **aanvraag.**

3. Zoek op **de pagina De aanvraag** starten de sectie **CSP - klanten, orders en abonnementen**. In deze sectie kiest u **Een probleemtype selecteren** en selecteert u vervolgens **Tegoedaanvragen voor klantenservice.**

4. Kies op **de pagina** Aanbevolen oplossingen onder Hebt u meer **hulp nodig?** de optie **Ja.**

5. Vul op **de** pagina Details de sectie **Probleemdetails** in. Voer in **het** tekstvak Details de vereiste gegevens in die u eerder hebt verzameld.

6. Kies **Verzenden om** uw SLA-tegoedaanvraag te verzenden.
...
6. Vul op **de** pagina Details de sectie **Probleemdetails** in. Voer in **het** tekstvak Details de vereiste gegevens in die u eerder hebt verzameld.

7. Kies **Verzenden om** uw SLA-tegoedaanvraag te verzenden.
Voor tegoedaanvragen voor verouderde aanbiedingen van Microsoft 365 of Microsoft Dynamics 365 (bijvoorbeeld wanneer het aantal licenties per ongeluk is verhoogd of het verkeerde product is aangeschaft):
...
- Tegoeden worden pro rated op basis van de betrokken service en de duur van de storing. Zie het document Online Services Consolidated SLA voor de typen scenario's die in aanmerking komen voor [SLA-tegoed.](https://www.microsoft.com/licensing/docs/view/Service-Level-Agreements-SLA-for-Online-Services) Deze informatie is ook van toepassing op services die via Cloud Solution Provider programma (CSP) worden verkocht.
...
> [!NOTE]
> Adviesincidenten komen doorgaans niet in aanmerking voor SLA-tegoed. Een incident dat op het Service Health Dashboard wordt geplaatst, geeft aan dat een *tenant* mogelijk wordt beïnvloed en de beste informatie vertegenwoordigt die Microsoft op het moment van publicatie heeft. Statuspaginagegevens vertegenwoordigen de algemene beschikbaarheid van een service. De impact, beperking en oplossing van afzonderlijke service kan variëren. U kunt de laatste incidentpost en incidentbeoordeling bekijken voor meer informatie. Zie How to check Microsoft 365 service health (Service health controleren) Microsoft 365 service health (Status van [service controleren) voor meer informatie over service health.](/microsoft-365/enterprise/view-service-health)
