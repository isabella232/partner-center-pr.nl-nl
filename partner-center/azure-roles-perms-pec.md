...
|API Management serviceoperatorrol|Kan de service beheren, maar niet de API's|Yes|
...
Azure Kubernetes Service clusterbeheerdersrol | De actie Clusterbeheerderreferenties opsommen. | Yes | 
...
Inzender voor back-ups | Hiermee kunt u de back-upservice beheren, maar u kunt geen kluizen maken en anderen toegang verlenen | Yes | 
Back-upoperator | Hiermee kunt u back-upservices beheren, behalve het verwijderen van back-ups, het maken van een kluis en het verlenen van toegang aan anderen | Yes | 
...
Toegang tot blockchain-lid-knooppunt (preview) | Hiermee kunt u toegang krijgen tot blockchainlidknooppunten | Yes | 
...
Data Box Reader | Hiermee kunt u de Data Box beheren, behalve het maken van order- of bewerkingsgegevens en het verlenen van toegang aan anderen. | No | 
Data Factory-inzender | Maak en beheer gegevensfabrieken en onderliggende resources in deze resources. | Yes | 
Data Lake Analytics Developer | Hiermee kunt u uw eigen taken verzenden, bewaken en beheren, maar geen accounts Data Lake Analytics maken of verwijderen. | Yes | 
...
Beveiligingsbeheerder | Alleen Security Center: Kan beveiligingsbeleid weergeven, beveiligingsbeleid bekijken, beveiligingsbeleid bewerken, waarschuwingen en aanbevelingen weergeven, waarschuwingen en aanbevelingen weg doen | Yes | 
Security Manager (verouderd) | Dit is een verouderde rol. Gebruik in plaats daarvan Beveiligingsbeheerder | Yes | 
Beveiligingslezer | Alleen Security Center: Kan aanbevelingen en waarschuwingen weergeven, beveiligingsbeleid weergeven, beveiligingswaarschuwingen bekijken, maar geen wijzigingen aanbrengen | No | 
Site Recovery-inzender | Hiermee kunt u de Site Recovery beheren, behalve het maken van een kluis en roltoewijzing | Yes | 
Site Recovery-operator | Hiermee kunt u failover en failback uitvoeren, maar geen andere Site Recovery uitvoeren | Yes | 
...
SQL Server Inzender | Hiermee kunt u SQL servers en databases beheren, maar geen toegang krijgen tot deze servers en niet hun beveiligingsbeleid. | Yes | 
...
Inzender met verhoogde bevoegdheden voor opslagbestandsgegevens via SMB-share | Hiermee kunt u NTFS-machtigingstoegang lezen, schrijven, verwijderen en wijzigen in Azure Storage via SMB | Yes | 
...
Aanmelding bij de beheerder van de virtuele machine | De Virtual Machines in de portal weergeven en u aanmelden als beheerder | Yes | 
Inzender voor virtuele machines | Hiermee kunt u virtuele machines beheren, maar geen toegang tot deze machines, en niet tot het virtuele netwerk of opslagaccount waarmee ze zijn verbonden. | Yes | 
