...
description: Introduceert beveiligingsvereisten van partners voor het inschakelen van Multi-Factor Authentication (MFA) en het veilig toepassingsmodel framework.
author: vijvala
ms.author: vijvala
...
2. **Gebruik het veilig toepassingsmodel framework**. Alle partners die integreren met Partner Center API's, moeten het [veilig toepassingsmodel framework](/partner-center/develop/enable-secure-app-model) gebruiken voor toepassingen met een app- en gebruikersver auth-model.
...
- Implement [Azure Active Directory (Azure AD)-standaardinstellingen voor beveiliging.](/azure/active-directory/conditional-access/concept-conditional-access-security-defaults) Zie de volgende [sectie voor meer informatie.](#security-defaults)

- Aankoop Azure Active Directory Premium voor elk gebruikersaccount. Zie Plan [an Azure AD Multi-Factor Authentication deployment (Een Azure AD Multi-Factor Authentication-implementatie plannen) voor meer informatie.](/azure/active-directory/authentication/howto-mfa-getstarted)
...
#### <a name="do-you-have-office-365-users-with-licenses-associated-with-your-partner-tenant"></a>Hebt u gebruikers Office 365 licenties die zijn gekoppeld aan uw partnerten tenant?
...
Als u moderne verificatie wilt inschakelen voor apparaten met Windows die Microsoft Office 2013 hebben geïnstalleerd, moet u twee registersleutels maken. Zie [Moderne verificatie inschakelen Office 2013 op Windows apparaten.](/office365/admin/security-and-compliance/enable-modern-authentication)
...
Na activering wordt gebruikers in de tenant van de partner gevraagd om MFA-verificatie te voltooien wanneer ze een beheerder uitvoeren namens (AOBO)-bewerkingen, toegang tot de Partner Center-portal of het aanroepen van Partner Center API's. Zie [Multi-Factor Authentication (MFA)](partner-security-requirements-mandating-mfa.md)voor uw partner-tenant voor meer informatie. 
...
- [Partner Center Java-voorbeelden:](https://github.com/microsoft/partner-center-java-samples)deze GitHub-opslagplaats bevat voorbeelden, ontwikkeld met behulp van Java, die laten zien hoe u het veilig toepassingsmodel framework kunt implementeren.
