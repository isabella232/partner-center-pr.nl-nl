...
>[!IMPORTANT]
>In dit artikel wordt uitgelegd hoe u de voor delen van uw Microsoft Partner Network (MPN) kunt gaan gebruiken in het partner centrum-deze site. Als u geen uitnodiging hebt ontvangen om uw bedrijfs gegevens te verplaatsen van het Partner Membership Center (PMC) naar het partner centrum, moet u uw MPN-lidmaatschaps voordelen in PMC blijven beheren. [Meld](https://partner.microsoft.com/_login?authType=OpenIdConnect) u nu aan bij PMC.

Wanneer u deelneemt aan de Microsoft Partner Network (MPN), krijgt u toegang tot de voor delen van het lidmaatschap waarmee u uw bedrijf kunt bouwen en uitbreiden. Als u nog geen lid bent van MPN, kunt u deel nemen aan [de MPN-site](https://partner.microsoft.com/membership).

## <a name="manage-your-membership-benefits-in-the-partner-center"></a>Uw lidmaatschaps voordelen beheren in het partner centrum

Nadat u een lidmaatschaps voordeel pakket hebt aangeschaft, moet u software sleutels ophalen en licenties, abonnementen en andere voor delen aan werk nemers toewijzen om ze te gaan gebruiken.
...
1. Selecteer **Software** om uw lijst met software voordelen te bekijken.

2. Zoek het product dat u wilt gebruiken en selecteer vervolgens de pijl-omlaag aan de rechter kant van de rij om de details van het product uit te breiden.

3. Voor elk software product dat u wilt gaan gebruiken:

   a. Selecteer **sleutels ophalen** om de product licentie sleutels weer te geven. Zorg ervoor dat u alle speciale instructies volgt die worden weer gegeven.

   b. Selecteer de taal waarin u het product wilt weer geven.

   c. Selecteer het type besturings systeem (OS) van de computers waarop u de software wilt installeren.
...
1. Selecteer **Visual Studio-abonnementen** om uw lijst met Visual Studio-abonnementen weer te geven.
...
4. Herhaal dit proces voor elk abonnement dat u wilt toewijzen. Gebruikers kunnen hun abonnementen beheren in de Visual Studio-Portal.
   ...
   >[!Note]
   >Visual Studio-abonnements beheerders kunnen abonnementen van de ene abonnee opnieuw toewijzen aan een andere als 90 dagen zijn verstreken sinds de oorspronkelijke toewijzing. Lees de [micro soft partner programes Guide (Engelstalig](https://aka.ms/partner-benefits-use-guide)) voor meer informatie.

## <a name="manage-technical-benefits"></a>Technische voor delen beheren

In deze sectie wordt beschreven hoe u de voor delen van technische ondersteuning in het [dash board](https://partner.microsoft.com/dashboard)van de Partner Center kunt activeren en beheren. Als uw Microsoft Partner Network-lidmaatschap zich nog steeds in het PMC (Partner Membership Center) bevindt, moet u contact opnemen met een andere resource, zoals partner Frontline, zodat u uw technische voor delen kunt activeren. Zie [technische voor delen activeren buiten het partner centrum](partner-membership-center-tech-benefits-activate.md).

Ga als volgt te werk om uw technische voor delen te bekijken in Partner Center:
...
4. Eenmaal geactiveerd, kunt u technische voor delen voor verschillende soorten technische ondersteuning gebruiken. Lees de gedetailleerde instructies op de pagina technische voor delen om technische ondersteunings aanvragen voor de volgende services in te dienen. Zie ook de details hieronder.

   Op de pagina technische voor delen van partner Center worden de volgende typen technische ondersteuning beschreven:
   ...
   **Technische ondersteuning (oplossen).** Gebruik dit type technische ondersteuning wanneer de functionaliteit wordt verbroken of wanneer iets niet werkt zoals verwacht (bijvoorbeeld wanneer er een fout bericht wordt weer gegeven). Hier volgt een aantal richt lijnen:
   ...
   - Gebruik **micro soft product support** incidenten voor **recente on-premises producten** (alleen huidige en vorige versies) voor zowel Action Pack als Gold/Silver-competentie partners.
     ...
     >[!NOTE]
     > De toegangs-ID en contract-ID zijn vereist voor technische ondersteunings aanvragen voor on-premises, Azure (non-CSP) en Dynamics-producten. Als u uw toegangs-ID en contract-ID in de toekomst wilt vinden, kunt u ook [uw voor delen vinden](mpn-find-benefits.md#find-access-id-and-contract-id-for-technical-benefits).
  
   **Technische services voor preverkoop en implementatie.**  Gebruik dit type ondersteuning voor overleg of advies met betrekking tot technische verkoop of implementatie. Deze services kunnen rechtstreeks vanuit het [partner centrum](https://partnercenter.microsoft.com/pcv/partnership/benefits/createadvisoryhoursservicerequest)worden aangevraagd.

   - Gebruik voor zowel Action Pack als Gold/Silver-competentie partners **technische preverkoop-en implementatie services** voor Cloud-en hybride oplossingen.
...
1. Selecteer **voor delen** en klik vervolgens op de **markt** om uw lijst met aanbiedingen te zien die zijn gekoppeld aan de go-to-Market met het micro soft-programma.

   Met de [Go-to-Market-functies](mpn-learn-about-go-to-market-benefits.md) kunt u aanvullende marketing bronnen, aanbiedingen, Program ma's en hulp bieden die voor u beschikbaar zijn. Welke typen aanbiedingen beschikbaar zijn, is afhankelijk van uw specifieke partner niveau en alle competenties die u mogelijk al hebt verkregen.
...
Als u een voor deel of aanbieding wilt annuleren en een restitutie wilt ontvangen, moet u de aanvraag binnen 30 dagen na aankoop doen en de software voordelen niet hebben geactiveerd. Vraag de annulering via een service aanvraag.
...
- [Meer informatie over MPN go-to-Market-aanbiedingen en-resources](mpn-learn-about-go-to-market-benefits.md)
