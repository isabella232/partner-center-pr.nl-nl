...
Zie Abonnementen en prijzen voor commerciële marketplace-aanbiedingen voor meer informatie over landspecifieke prijzen (bijvoorbeeld om toekomstige belasting [te compenseren).](/azure/marketplace/plans-pricing#custom-prices)
...
**Scenario F:** alle transacties tussen externe uitgevers en eu-klanten met btw-nummer (btw) die zijn geregistreerd (buiten Ierland) in een Microsoft-Managed land. De klant betaalt geen belasting over de verkoop.
