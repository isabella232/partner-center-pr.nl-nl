...
Wanneer een partner bijvoorbeeld bepaalde niveaus van impact in sleutelindicatoren bereikt, kan de partner de Silver- of Gold Cloud-Business Applications verkrijgen (of behouden).
...
Een partner wordt de CPOR als deze een klant op abonnementsniveau heeft gevonden via de Dynamics 365 Online Services Advisor(OSA)-incentive of dynamics 365 OSU-incentive (Online Services Usage). Zie Understand [CPOR associations (CPOR-verbanden begrijpen) voor meer informatie.](incentives-customer-associations-intro.md)
...
- Een **verloren klant** wordt gedefinieerd onder de volgende voorwaarden: Wanneer een klant in een vorige maand ten minste één betaalde seat heeft voor al zijn abonnementen en in de huidige maand geen betaalde seats heeft. 
...
### <a name="definitions-for-pci-metric-3---functional-consultants"></a>Definities voor PCI-#3 - Functionele consultants
...
- Voor customer engagement Functioneel consultant certificering moet een persoon het volgende doorgeven:
  - MB-200 \* of PL-200<br/>
  **en** een van de volgende examens:
  - MB-210, MB-220, MB-230, MB-240 of MB6-898. \* \*

- Voor de certificering Functioneel consultant Finance and Operations-certificering moet een persoon het volgende doorgeven:
  - MB-300<br/>
  **en** een van de volgende examens:
...
- Functionele consultantgroei wordt gedefinieerd als de groei van het aantal gecertificeerde Functioneel consultant Associates sinds een momentopname van de basislijn. De momentopnamedatum van de basislijn wordt gemaakt op 1 oktober 2020.
...
- Als u in aanmerking wilt komen voor punten, moet u minimaal **15** Functioneel consultant-partners voor ontwikkelde marktpartners en **5** voor ontwikkelpartners hebben wanneer de momentopname van de basislijn wordt gemaakt.
