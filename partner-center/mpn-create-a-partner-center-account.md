...
2. U kunt zich aanmelden met uw Office 365 werkaccount, bijvoorbeeld you@contoso.onmicrosoft.com .
   ...
   > [!NOTE]
   > U kunt uw bestaande CSP-accountreferenties of een overheidsdomein niet gebruiken om u in te schrijven bij MPN. MPN is een wereldwijd programma en biedt geen ondersteuning voor inschrijving met een overheidsdomein. Als u geen e-mailadres of tenant in de wereldwijde cloud hebt, kunt u een openbare [tenant maken](/azure/active-directory/fundamentals/active-directory-access-create-new-tenant) en vervolgens de stappen in dit artikel volgen.
...
4. Selecteer **Nu inschrijven.**
    ...
    >[!IMPORTANT]
    >Om de beveiliging en privacy van uw bedrijf te waarborgen, sturen we een e-mail naar uw primaire contactpersoon om het e-mailadres te verifiëren en ervoor te zorgen dat het e-mailadres van uw bedrijf is. Nadat de primaire contactpersoon het e-mailadres heeft geverifieerd, gaan we verder met het controleren van de informatie die u hebt opgegeven. Verificatie duurt meestal 3-5 werkdagen. 
...
Meld u aan Partner Center met uw MPN-referenties. Selecteer [**Partnerprofiel om**](https://partner.microsoft.com/pcv/accountsettings/connectedpartnerprofile) de juridische gegevens van uw bedrijf, uw verificatiestatus en uw MPN-ID's weer te geven en indien nodig ook nieuwe MPN-locaties te maken. 
