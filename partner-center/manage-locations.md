...
De MPN-id van de locatie identificeert elke specifieke locatie van uw bedrijf. U gebruikt de MPN-locatie-id voor inschrijving in incentive-programma's, voor het transacteren van Cloud Solution Provider (CSP) business en andere zakelijke transacties. De algemene MPN-id wordt gebruikt voor niet-transactionele activiteiten, zoals ondersteuningsaanvragen.
