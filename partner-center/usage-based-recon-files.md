...
**Juiste rollen:** Accountbeheerdersaccounts | Factureringsbeheerder

Als u uw kosten wilt afstemmen op het gebruik van een klant, vergelijkt u de  **ResellerID,** **ResellerName** en **ResellerBillableAccount** uit het afstemmingsbestand met de klantnaam en abonnements-id uit Partner Center. 
...
| Regio | De regio waarop het gebruik van toepassing is. Wordt voornamelijk gebruikt om tarieven toe te wijzen aan gegevensoverdrachten, omdat de tarieven per regio verschillen. | *Azië en Stille Oceaan*, *Europe* *, Latijns-Amerika*, *Noord-Amerika* |
...
| MeteredRegion | Hiermee wordt de locatie van een datacenter binnen de regio geïdentificeerd (voor services waar deze waarde van toepassing is en ingevuld). | *Azië - oost*, *Azië - oost*, *Europa - noord*, *Europa - west*, *VS*- noord-centraal , VS - zuid-centraal en VS *- zuid-centraal* |
