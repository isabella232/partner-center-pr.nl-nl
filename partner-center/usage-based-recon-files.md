...
| MeteredRegion | Hiermee wordt de locatie van een datacenter binnen de regio geïdentificeerd (voor services waar deze waarde van toepassing is en ingevuld). | *Azië - oost*, *Azië - oost*, *Europa - noord*, Europa - west , VS *-* *noord-centraal*, *VS - zuid-centraal* |
