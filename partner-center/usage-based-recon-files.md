...
| CustomerCompanyName | De organisatienaam van de klant, zoals gerapporteerd in Partner Center. *Zeer belangrijk voor het afstemmen van de factuur met uw systeemgegevens.* | *Testklant* |
| MpnId | MPN-id van de CSP-partner. | *4390934* |
...
| OrderID | Unieke id voor een order in het Microsoft-factureringsplatform. Kan handig zijn om het abonnement te identificeren wanneer u contact op met de ondersteuning opzegt. Niet gebruikt voor afstemming. | *566890604832738111* |
