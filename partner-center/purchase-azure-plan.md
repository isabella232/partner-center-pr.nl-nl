...
2. Zoek de klant die Azure-reserveringen wil aanschaffen en selecteer vervolgens de pijl-omlaag om de rij van de klant uit te vouwen.
...
> [!NOTE]
> Het bereik van een reservering kan alleen worden ingesteld **op Gedeeld,** momenteel in Partner Center. Als u een bereik voor één abonnement wilt selecteren of wilt bijwerken van gedeeld abonnementsbereik naar het bereik van één abonnement, gaat u **naar Microsoft Azure Beheerportal** met behulp van de volgende instructies. 
...
1. Selecteer klanten Partner Center in het menu van uw [dashboard.](https://partner.microsoft.com/dashboard/)
Zoek de klant die Azure-reserveringen wil aanschaffen en selecteer vervolgens de pijl-omlaag om de rij van de klant uit te vouwen.
