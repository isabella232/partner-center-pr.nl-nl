...
#### <a name="how-do-i-find-set-up-or-update-payout-and-tax-details"></a>Hoe kan ik u uitbetalings- en belastinggegevens zoeken, instellen of bijwerken?

Zie Uw uitbetalingsaccount en belastingformulieren instellen voor gedetailleerde informatie over het bijwerken van betalings- en belastinggegevens in [Partner Center.](set-up-your-payout-account.md)
...
Neem contact op met uw accountbeheerder om meer domeinen toe te voegen aan het AAD-account.
 
#### <a name="my-organization-is-participating-in-multiple-programs-do-i-need-to-provide-my-payment-and-tax-profile-multiple-times"></a>Mijn organisatie neemt deel aan meerdere programma's. Moet ik mijn betalings- en belastingprofiel meerdere keren verstrekken?

Dit is afhankelijk van de behoeften van uw organisatie. Betalingsprofielen worden gemaakt op organisatieniveau, waardoor hetzelfde bankprofiel kan worden toegewezen aan meerdere MPN-id's en programma's binnen een organisatie. In de meeste gevallen kunt u een bestaand profiel opnieuw gebruiken of een nieuw profiel maken.
...
Belastingprofielen die zijn gemaakt voor een MPN-locatie, worden opnieuw gebruikt en automatisch ingevuld wanneer dezelfde MPN-locatie deelneemt aan een ander programma. Maar er kunnen uitzonderingen zijn. De regels voor uitbetaling van een nieuw incentive-programma kunnen bijvoorbeeld extra gegevens vereisen voor het belastingprofiel.

#### <a name="can-i-use-the-same-bank-and-tax-details-for-all-incentive-programs-at-microsoft"></a>Kan ik dezelfde bank en belastinggegevens gebruiken voor alle incentive-programma's bij Microsoft?

Als uw bedrijf is uitgenodigd voor meerdere programma's, kunt u hetzelfde betalingsaccount gebruiken voor al uw programma's of verschillende betalingsaccounts voor de verschillende programma's hebben.


#### <a name="how-does-microsoft-ensure-that-the-bank-information-is-indeed-that-of-the-company-and-not-a-personal-bank-account-for-an-employee"></a>Hoe zorgt Microsoft ervoor dat de bankgegevens inderdaad van het bedrijf zijn en niet van een persoonlijke rekening voor een werknemer?

Het is de verantwoordelijkheid van het bedrijf om ervoor te zorgen dat de rol van incentives-beheerder - die de machtigingen heeft om deze informatie te bewerken - alleen wordt verleend aan de juiste werknemers.

#### <a name="my-tax-profile-has-expired-how-do-i-fix-update-it"></a>Mijn belastingprofiel is verlopen. Hoe kan ik update oplossen?

Als een belastingprofiel is verlopen of bijna verloopt, betekent dit dat het belastingformulier dat u aan Microsoft hebt opgegeven, moet worden bijgewerkt. Gebruik de volgende stappen om uw belastingprofiel bij te werken:

1. Meld u aan Partner Center [dashboard en](https://partner.microsoft.com/dashboard/home)selecteer vervolgens het tandwielpictogram om het menu Instellingen **te** openen.
...
5. Selecteer **Bewerken om** het bewerkingsproces voor belastingprofiel te starten.
6. Geef in de sectie belastingformulier de bijgewerkte gegevens op.

## <a name="earnings-incorrect-or-missing"></a>Inkomsten onjuist of ontbreken
...
- Controleer het [tijdsbestek van de uitbetalingscyclus en](payment-thresholds-methods-timeframes.md) begrijp wanneer uw inkomsten moeten worden weergegeven in het uitbetalingsoverzicht.
...
- Zorg ervoor dat uw Uitbetalingsstatus en Belastingprofielstatus als *geldig worden weergegeven* op de [overzichtspagina.](https://partner.microsoft.com/dashboard/commercial-marketplace/overview)
...
#### <a name="how-do-i-view-historical-information"></a>Hoe kan ik historische informatie weergeven?
...
Gebruik de [Api voor uitbetaling van partners.](https://apidocs.microsoft.com/services/partnerpayouts)

## <a name="commercial-marketplace-payout-policies"></a>Uitbetalingsbeleid voor commerciële marketplace
...
- [Betaald krijgen](marketplace-get-paid.md)
