...
Wanneer Microsoft Azure namens uw klanten reserveringen koopt, moet u een virtuele machine (VM) kiezen die is geformatteerd om te voldoen aan de computerbehoeften van de klant. U vindt deze informatie op een van de volgende manieren:
