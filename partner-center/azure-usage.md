...
description: Meer informatie over hoe u de grootte van een virtuele machine (VM) aan de computerbehoeften van uw klanten kunt aanmeten wanneer u Microsoft Azure reservering voor hen koopt.
ms.topic: how-to
...
In dit artikel wordt uitgelegd hoe u de grootte van een virtuele machine (VM) kunt berekenen aan de computerbehoeften van uw klanten wanneer u Microsoft Azure voor hen koopt.
...
Wanneer u Microsoft Azure namens uw klanten een reservering koopt, moet u een virtuele machine (VM) kiezen die voldoet aan de computerbehoeften van de klant. U vindt deze informatie op een van de volgende manieren:
...
4. Zoek op de detailpagina van de VM de grootte en regiogegevens, zoals hieronder wordt weergegeven, en gebruik deze informatie om de reservering in de Partner Center.  
...
U kunt reserveringsgebruiksgegevens op halen met de Azure-gebruiks-API om te controleren of de klant de reserveringskorting krijgt en om te zien op welke VM's (virtuele machines) de korting wordt toegepast. Vergelijk voorbeeld A met voorbeeld B om te zien hoe u het reserveringsgebruik van een klant kunt controleren.
