...
| MeterRegion | In deze kolom wordt de locatie van een datacenter in de regio voor services geïdentificeerd waar MeterRegion van toepassing is en wordt ingevuld. |
...
| PricingPreTaxTotal | De prijzen, vóór belasting worden toegevoegd. |
...
| PCToBCExchangeRate | Exchange tarief toegepast op prijsvaluta op factureringsvaluta. |
