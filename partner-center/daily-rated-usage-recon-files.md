...
ms.topic: article
ms.date: 06/12/2020
description: Meer informatie over het lezen van bestanden voor afstemming van dagelijks gebruik in Partner Center. Bevat beschrijvingen voor specifieke velden in het reconbestand.
...
| UnitPrice | Prijs per licentie, zoals gepubliceerd in de prijslijst op het moment van aankoop. Zorg ervoor dat deze prijs overeenkomt met de gegevens die tijdens de afstemming in uw factureringssysteem zijn opgeslagen. |
| Aantal | Aantal licenties. Zorg ervoor dat deze prijs overeenkomt met de gegevens die tijdens de afstemming in uw factureringssysteem zijn opgeslagen. |
...
| PCToBCExchangeRate | Exchange tarief dat wordt toegepast op de prijsvaluta op factureringsvaluta. |
