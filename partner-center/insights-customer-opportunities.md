...
1. **De belangrijkste Onmanaged** omvat de grootste SMB-klanten met de meeste mogelijkheden voor Microsoft. Typische niet-beheerde klanten delen vergelijkbare kenmerken als beheerde accounts, met een groot aantal werknemers, grote IT-budgetten en -uitgaven en grote hoeveelheden potentiële omzet voor Microsoft.
   ...
   - **Belangrijkste niet-managed op basis van gebruikers:** bevat accounts met 300 of meer werknemers. User-Based zijn geweldige doelen voor de eerste aankoop of uitbreiding van abonnementsproducten op basis van gebruikers, zoals Microsoft 365, Dynamics 365 of Surface.
...
De volgende schermopname vertegenwoordigt de vier SMB-subsegmenten. CloudAscent prioriteert de profilering, score en modellering van alle niet-beherende en middelgrote bedrijfsaccounts.
