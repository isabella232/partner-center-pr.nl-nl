...
> [!Note] 
> Alleen CSP-partners met de mogelijkheid tot transact kunnen prijslijsten bekijken en downloaden. Indirecte resellers moeten [contact opnemen met hun CSP-provider om]( https://partner.microsoft.com/cloud-solution-provider/find-a-provider) details over de prijzen op te vragen
...
|Type licentieovereenkomst   |Typen licentieovereenkomst kunnen zakelijk, overheids- of academisch zijn. Het type overeenkomst bepaalt aan welke klanttypen de aanbieding kan worden verkocht.|
...
|Type eindklant   |Heeft weer te maken met het type licentieovereenkomst: bedrijfslicentie - zakelijke cloud reseller, overheidslicentie - cloud reseller overheid of academische licentie - faculteits- of cloud reseller-student   |
...
Partnermarges, het verschil tussen de catalogusprijs en de geschatte detailhandelsprijzen, kunnen per segment verschillen. Normaal gesproken hebben onderwijs en non-profitorganisatie lagere of geen marges voor CSP-partners. Raadpleeg de prijslijst op basis van licenties voor exacte waarden. 
...
Deze aankoopbeperkingen worden gedefinieerd als onderdeel van de configuratie van de aanbieding en kunnen worden gevonden door te kijken in de aanbiedingslijstmatrix. Twee kolommen met gegevens werken samen om de afdwinging te definiëren: 1. Aanbiedingslimietbereik en 2. Aanbiedingslimiet. De beperkingen worden afgedwongen tijdens een aankoop. De catalogus in Partner Center een partner niet toestaan om meer aanbiedingen aan te kopen dan volgens de regels is toegestaan. Elke poging om de beperkingen te schenden, resulteert in een fout.
...
Microsoft 365 A1 basisaanbieding heeft een termijn van zes jaar.  De Office 365 A1 zijn beschikbaar na aankoop van deze basisaanbieding. 
...
- Dit abonnement kan niet worden geannuleerd en er kan geen restitutie voor worden ontvangen.
...
Prijslijsten bevatten basisinformatie over prijzen (hoeveel het kost). De aanbiedingsmatrix bevat aankoopgegevens over de producten (hoe u deze kunt kopen). Veel van de informatie in deze downloadbestanden is ook toegankelijk via de verschillende Partner Center API's (catalogus-API's en API's voor prijzen).
...
De structuur van items in het nieuwe handelsprijzenbestand wijkt af van de traditionele lijst met kantoorprijzen. 
