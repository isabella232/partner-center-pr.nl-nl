...
description: Meer informatie over hoe een Cloud Solution Provider (CSP)-programmapartner Partner Center om over te gaan van directe factuurpartner naar indirecte reseller.
...
1. Zorg ervoor dat uw partnerprofielen in Partner Center en Microsoft Partner Network(MPN)-id actueel zijn.

2. Meld u aan bij [Partner Center dashboard als](https://partner.microsoft.com/dashboard) de globale beheerder voor de tenant voor directe factuur die u over wilt zetten naar een indirecte reseller.
...
>[!NOTE]
>De sandbox-mogelijkheden zijn alleen beschikbaar voor partners met directe factuur. Wanneer u overstapt van Directe factuur naar Indirecte reseller, hebt u geen toegang meer tot de sandboxmogelijkheden.
...
Wanneer u een indirecte provider vindt om mee samen te werken, moet u een partnerschap met de indirecte provider in Partner Center.
...
1. Selecteer **Indirecte providers in** het linkernavigatie Partner Center navigatiebalk.
...
U kunt de functie voor de uitbreiding van reseller-relaties gebruiken om een resellerrelatie tot stand te brengen tussen uw bestaande klanten met directe factuur en uw indirecte provider met behulp van Partner Center Dashboard. Let op het volgende voordat u de functie gebruikt:
...
- **De klant heeft de Microsoft-klantovereenkomst geaccepteerd**
...
7. Selecteer **Waar nodig** **Accepteren** of Afwijzen.
...
6. Controleer of de abonnementen niet meer als actief worden weergegeven op **de pagina** Abonnementen:
   ...
   - Als dit een Azure-abonnement (MS-AZR-0145P) is, wordt het niet meer weergegeven.

   - Als dit een op licenties gebaseerd abonnement (Office 365, Dynamics, Intune) is, wordt dit weergegeven met de status **Tijdelijk.**
