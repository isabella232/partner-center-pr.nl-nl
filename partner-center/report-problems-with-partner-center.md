...
1. Meld u aan bij [Partner Center dashboard en](https://partner.microsoft.com/dashboard) selecteer het Help-pictogram (**?**) en selecteer **vervolgens Ondersteuning.**

    :::image type="content" source="./images/support/invoke-support-dropdown.png" alt-text="Schermopname van het Help-pictogram en het vervolgkeuzemenu.":::

2. Voer **onder Probleemsamenvatting** een kort overzicht van het probleem in.

3. Onder **Probleemtype kunt** u kiezen uit aanbevolen inhoud of aanvullende trefwoorden invoeren om uw zoekopdracht te verfijnen.

    :::image type="content" source="./images/support/support-example.png" alt-text="Schermopname van de probleemsamenvatting en typ velden in het ondersteuningsticket.":::

4. Bekijk de **pagina Aanbevolen oplossingen** voor waarschuwingen, stappen of gerelateerde documenten die u kunnen helpen bij het oplossen van uw probleem.

5. Als de **aanbevolen oplossingen** uw probleem hebben opgelost, kunt u terugkeren naar het dashboard. Als u nog steeds hulp nodig hebt, kunt u doorgaan en **Details van probleem verstrekken selecteren.**

6. Vul de gegevens onder **Aanvraaggegevens in.** Wanneer u klaar bent, **selecteert u** Verzenden. Een vertegenwoordiger van de partnerondersteuning neemt contact met u op.

#### <a name="current-view"></a>[Huidige weergave](#tab/current-view)

1. Meld u aan bij [Partner Center dashboard,](https://partner.microsoft.com/dashboard)selecteer **Ondersteuning** en selecteer vervolgens **Partnerondersteuningsaanvragen.**
...
1. Meld u aan bij [Partner Center dashboard en](https://partner.microsoft.com/dashboard) selecteer het Help-pictogram (**?**), selecteer vervolgens Ondersteuning **en** selecteer vervolgens Overzicht om **uw** ondersteuningsaanvragen weer te geven.

2. Klik **onder Mijn ondersteuningsaanvragen** op uw open aanvraag om ticketgegevens weer te geven en selecteer **vervolgens Een afspraak plannen.**

    :::image type="content" source="./images/support/schedule-appointment-1.png" alt-text="Schermopname van de knop Afspraak plannen.":::

3. Selecteer een beschikbare datum en vervolgens tijd. De beschikbare afspraaktijden zijn gebaseerd op de agendabeschikbaarheid van de Support Advocate en worden weergegeven in uw lokale tijdzone.

    :::image type="content" source="./images/support/schedule-appointment-2.png" alt-text="Schermopname van de datum- en tijdselectie voor een ondersteuningsafspraak.":::

4. Selecteer **Deze afspraak plannen om** uw afspraak met een advocate te boeken.

5. Nadat de afspraak is gemaakt, ziet u de datum en tijd op de pagina met ticketdetails.

    :::image type="content" source="./images/support/schedule-appointment-3.png" alt-text="Schermopname van een bestaand ticket met informatie over een geplande afspraak.":::
...
7. Als u uw afspraak wilt wijzigen, gaat u terug naar de pagina met ticketdetails in Partner Center selecteert u Deze afspraak **opnieuw** plannen of **Deze afspraak annuleren.** 
    ...
    >
    > - Bevestigings- en herinneringsmails voor de vergadering zijn mogelijk in het Engels in plaats van uw geselecteerde taal. U ontvangt echter nog steeds ondersteuning in de geselecteerde taal.
...
2. Selecteer **Deze afspraak plannen om** uw afspraak met een advocate te boeken.

:::image type="content" source="images/support/ticket2.png" alt-text="Afspraak plannen.":::

3. Nadat de afspraak is gemaakt, Partner Center u de datum en tijd op de pagina met ticketdetails.
