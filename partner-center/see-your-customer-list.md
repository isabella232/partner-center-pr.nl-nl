...
3. Selecteer de **pijl-omlaag** aan het einde van de rij van een klant om de Microsoft-id en de bijbehorende snelle koppelingen voor abonnementen en services weer te geven.
...
2. Selecteer **Klanten exporteren.**
   ...
   - **Relatie:** de zakelijke relatie van de partner met elke vermelde klant.
    ...
    Standaard exporteert Partner Center de volledige klantlijst, ongeacht de lengte. U kunt ook zoeken in de lijst met klanten op bedrijfsnaam of -domein en die subset met gegevens exporteren.
